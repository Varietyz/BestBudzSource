...
public final class RSInterface {
	...
	private static final String[] musicNames = { "7th Realm", "A Familiar Feeling", "A New Menace", "A Pirate's Life for Me", "Adorno I", "Adorno II", "Adorno III", "Adorno IV", "Adorno IX", "Adorno V", "Adorno VI", "Adorno VII", "Adorno VIII", "Adorno X", "Adventure", "Al Kharid", "All's Fairy in Love and War", "Alone", "Altar Ego", "Alternative Root", "Ambient Jungle", "An Easter United", "Ancestral Wisdom", "Animal Apogee", "Anywhere", "Arabian", "Arabian 2", "Arabian 3", "Arabique", "Ardougne Ago", "Arma Gonna Get You", "Armadyl Alliance", "Armageddon", "Army of Darkness", "Arrival", "Artistry", "Assault and Battery", "Assault 1", "Assault 2", "Assault 3", "Assault 4", "Assault 5", "Assault 6", "Attention", "Autumn Voyage", "Aye Car Rum Ba", "Aztec", "Back to Life", "Background", "Bal'lak the Pummeller", "Ballad of Enchantment", "Bandit Camp", "Bandos Battalion", "Bane of Summer", "Barb Wire", "Barbarianism", "Barking Mad", "Baroque", "Battle of Souls", "Beetle Juice", "Beyond",
			...
			"Glorious Recallation...", "Glorious Recallation...", "Gnome King", "Gnome Village", "Gnome Village 2", "Gnomeball", "Goblin Game", "Goblin Village", "Godmercenary", "Golden Touch", "Greatness", "Grimly Fiendish", "Grip of the Talon", "Grotto", "Ground Scape", "Grumpy", "Guthix's Hunter", "H.A.M. Fisted", "Ham and Seek", "Ham Assault", "Har'Lakk the Riftsplitter", "Hare-brained Bitches", "Harmony", "Harmony 2", "Haunted Quarry", "Have a Blast", "Have an Ice Day", "Head to Head", "Healin' Feelin'", "Heart and Mind", "Hell's Bells", "Hermit", "High Seas", "High Spirits", "Historic Memories", "Hobgoblin Geomancer", "Home Sweet Home", "Homescape", "Honkytonky Harmony", "Honkytonky Medieval", "Honkytonky Newbie Melody", "Honkytonky Parade", "Honkytonky Sea Shanty", "Horizon", "Hot 'n' Bothered", "Hypnotized", "I'm Counting on You", "Iban", "Ice Day for Penguins", "Ice Melody", "Icy a Worried Gnome", "Icy Trouble Ahead", "Illusive", "Impetuous", "In Between", "In the Brine",
			"In the Clink", "In the Manor", "In the Pits", "Inadequacy", "Incantation", "Incarceration", "Insect Queen", "Inspiration", "Into the Abyss", "Intrepid", "Island Life", "Island of the Trolls", "Isle of Everywhere", "Itsy Bitsy...", "Jailbird", "Jaws of the Dagannoth", "Jester Minute", "Jolly-R", "Joy of the Hunt", "Jungle Bells", "Jungle Community", "Jungle Hunt", "Jungle Island", "Jungle Island XMAS", "Jungle Troubles", "Jungly 1", "Jungly 2", "Jungly 3", "Karamja Jam", "Kharidian Nights", "Kingdom", "Knightly", "Knightmare", "La Mort", "Labyrinth", "Lair", "Lair of Kang Admi", "Lament", "Lament of Meiyerditch", "Lamistard's Labyrinth", "Land Down Under", "Land of Snow", "Land of the Dwarves", "Landlubber", "Last Stand", "Lasting", "Lazy Wabbit", "Legend", "Legion", "Lexicus Runewright", "Life's a Beach!", "Lighthouse", "Lightness", "Lightwalk", "Little Cave of Horrors", "Living Rock", "Lonesome", "Long Ago", "Long Way Home", "Looking Back", "Lore and Order", "Lost Soul",
			"Lullaby", "Mad Eadgar", "Mage Arena", "Mage and Mystery", "Mage Dance", "Mage Mage Mage", "Mageal Journey", "Maiasaura", "Major Quarryr", "Making Waves", "Malady", "March", "Marooned", "Marzipan", "Masquerade", "Mastermindless", "Mausoleum", "Meddling Kids", "Medieval", "Mellow", "Melodrama", "Melzar's Maze", "Meridian", "Method of Madness", "Miles Away", "Mind Over Matter", "Miracle Dance", "Mirage", "Miscellania", "Mobilising Armies", "Monarch Waltz", "Monkey Madness", "Monster Melee", "Moody", "Morytania", "Mouse Trap", "Mudskipper Melody", "Mutant Medley", "My Arm's Journey", "Narnode's Theme", "Natural", "Neverland", "Newbie Melody", "Nial's Widow", "Night of the Vampyre", "Night-gazer Khighorahk", "Nightfall", "No Way Out", "Nomad", "Norse Code", "Null and Void", "Ogre the Top", "On the Up", "On the Wing", "Oriental", "Out of the Deep", "Over To Nardah", "Overpass", "Overture", "Parade", "Path of Peril", "Pathways", "Penguin Possible", "Pest Control",
			"Pharaoh's Tomb", "Phasmatys", "Pheasant Peasant", "Pinball Wizard", "Pirates of Penance", "Pirates of Peril", "Poison Dreams", "Poles Apart", "Prime Time", "Principality", "Quest", "Rammernaut", "Rat a Tat Tat", "Rat Hunt", "Ready for Battle", "Regal", "Reggae", "Reggae 2", "Rellekka", "Rest for the Weary", "Right on Track", "Righteousness", "Rising Damp", "Riverside", "Roc and Roll", "Roll the Bones", "Romancing the Crone", "Romper Chomper", "Roots and Flutes", "Royale", "Rune Essence", "Sad Meadow", "Safety in Numbers", "Saga", "Sagittare", "Saltwater", "Sarah's Lullaby", "Sarcophagus", "Sarim's Vermin", "Scape Cave", "Scape Hunter", "Scape Main", "Scape Original", "Scape Sad", "Scape Santa", "Scape Scared", "Scape Soft", "Scape Summon", "Scape Theme", "Scape Wild", "Scarab", "Scarabaeoidea", "School's Out", "Sea Shanty", "Sea Shanty 2", "Sea Shanty XMAS", "Second Vision", "Serenade", "Serene", "Settlement", "Shadow-forger Ihlakhizan", "Shadowland", "Shaping Up",
			"Shine", "Shining", "Shining Spirit", "Shipwrecked", "Showdown", "Sigmund's Showdown", "Silent Knight", "Slain to Waste", "Slice of Silent Movie", "Slice of Station", "Slither and Thither", "Slug a Bug Ball", "Smorgasbord", "Sojourn", "Something Fishy", "Soundscape", "Spa Bizarre", "Sphinx", "Spirit", "Spirits of Elid", "Splendour", "Spooky", "Spooky 2", "Spooky Jungle", "Stagnant", "Starlight", "Start", "Stealing Creation", "Still Night", "Stillness", "Stillwater", "Stomp", "Storeroom Shuffle", "Storm Brew", "Stranded", "Strange Place", "Stratosphere", "Vigour of Saradomin", "Subterranea", "Sunburn", "Superstition", "Surok's Theme", "Suspicious", "Tale of Keldagrim", "Talking Forest", "Tears of Guthix", "Technology", "Temple", "Temple Desecrated", "Temple of Light", "Temple of Tribes", "Terrorbird Tussle", "The stoner", "The stoners Re-United!", "The Art of Hocus-Pocus", "The Cellar Dwellers", "The Chosen", "The Chosen Commander", "The Columbarium",
	...
	public static void addLunar2RunesSmallBox(int ID, int r1, int r2, int ra1, int ra2, int rune1, int lvl, String name, String descr, int sid, int suo, int type) {
	...
	public static void addLunar3RunesBigBox(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1, int rune2, int lvl, String name, String descr, int sid, int suo, int type) {
	RSInterface rsInterface = addTabInterface(ID);
	rsInterface.id = ID;
	rsInterface.parentID = 1151;
	rsInterface.type = 5;
	...
	public static void addLunar3RunesLargeBox(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1, int rune2, int lvl, String name, String descr, int sid, int suo, int type) {
	RSInterface rsInterface = addTabInterface(ID);
	rsInterface.id = ID;
	rsInterface.parentID = 1151;
	rsInterface.type = 5;
	...
	public static void addLunar3RunesSmallBox(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1, int rune2, int lvl, String name, String descr, int sid, int suo, int type) {
	RSInterface rsInterface = addTabInterface(ID);
	rsInterface.id = ID;
	rsInterface.parentID = 1151;
	rsInterface.type = 5;
	...
	addLunar2RunesSmallBox(30025, 9075, 557, 0, 7, 30006, 65, "Cure Plant", "Cure disease on cultivation patch", 1, 4, 2);
	addLunar3RunesBigBox(30032, 9075, 564, 558, 0, 0, 0, 30013, 30007, 65, "Monster inspect", "Detect the combat statistics of a\\nmonster", 2, 2, 2);
	addLunar3RunesSmallBox(30040, 9075, 564, 556, 0, 0, 1, 30013, 30005, 66, "Mob Contact", "Speak with varied NPCs", 3, 0, 2);
	addLunar3RunesSmallBox(30048, 9075, 563, 557, 0, 0, 9, 30012, 30006, 67, "Cure Other", "Cure poisoned stoners", 4, 8, 2);
	addLunar3RunesSmallBox(30056, 9075, 555, 554, 0, 2, 0, 30004, 30003, 67, "Humidify", "fills certain vessels with water", 5, 0, 5);
	addLunar3RunesSmallBox(30064, 9075, 563, 557, -1, -1, -1, 30012, 30006, 68, "Profession Teleport", "Profession Teleport", 6, 0, 5);
	addLunar3RunesBigBox(30075, 9075, 563, 557, -1, -1, -1, 30012, 30006, 69, "Minigames", "Barrows & Assault", 7, 0, 5);
	addLunar3RunesSmallBox(30083, 9075, 563, 557, -1, -1, -1, 30012, 30006, 70, "Boss Teleport", "Boss Teleport", 8, 0, 5);
	...
	addLunar3RunesSmallBox(30106, 9075, 563, 555, -1, -1, -1, 30012, 30004, 71, "Pk Teleport", "Gives your several of options", 11, 0, 5);
	addLunar3RunesBigBox(30114, 9075, 563, 555, -1, -1, -1, 30012, 30004, 72, "Monster Teleport", "Monster Teleport", 12, 0, 5);
	addLunar3RunesSmallBox(30122, 9075, 564, 563, 1, 1, 1, 30013, 30012, 73, "Cure Group", "Cures Poison on stoners", 13, 0, 5);
	addLunar3RunesBigBox(30130, 9075, 564, 559, 1, 1, 4, 30013, 30008, 74, "Stat Spy", "Cast on another stoner to see their\\nprofession grades", 14, 8, 2);
	addLunar3RunesBigBox(30138, 9075, 563, 554, -1, -1, -1, 30012, 30003, 74, "Barbarian Teleport", "Teleports you to the Barbarian\\noutpost", 15, 0, 5);
	addLunar3RunesBigBox(30146, 9075, 563, 554, 1, 1, 5, 30012, 30003, 75, "Tele Group Barbarian", "Teleports stoners to the Barbarian\\noutpost", 16, 0, 5);
	addLunar3RunesSmallBox(30154, 9075, 554, 556, 1, 5, 9, 30003, 30005, 76, "Superglass Make", "Make glass without a furnace", 17, 16, 2);
	addLunar3RunesSmallBox(30162, 9075, 563, 555, 1, 1, 3, 30012, 30004, 77, "Khazard Teleport", "Teleports you to Port khazard", 18, 0, 5);
	addLunar3RunesSmallBox(30170, 9075, 563, 555, 1, 1, 7, 30012, 30004, 78, "Tele Group Khazard", "Teleports stoners to Port khazard", 19, 0, 5);
	addLunar3RunesBigBox(30178, 9075, 564, 559, 1, 0, 4, 30013, 30008, 78, "Dream", "Take a rest and restore life 3\\n times faster", 20, 0, 5);
	addLunar3RunesSmallBox(30186, 9075, 557, 555, 1, 9, 4, 30006, 30004, 79, "String Jewellery", "String amulets without wool", 21, 0, 5);
	addLunar3RunesLargeBox(30194, 9075, 557, 555, 1, 9, 9, 30006, 30004, 80, "Stat Restore Pot\\nShare", "Share a potion with up to 4 nearby\\nstoners", 22, 0, 5);
	addLunar3RunesSmallBox(30202, 9075, 554, 555, 1, 6, 6, 30003, 30004, 81, "Mage Imbue", "Combine runes without a talisman", 23, 0, 5);
	addLunar3RunesBigBox(30210, 9075, 561, 557, 2, 1, 14, 30010, 30006, 82, "Fertile Soil", "Fertilise a cultivation patch with super\\ncompost", 24, 4, 2);
	addLunar3RunesBigBox(30218, 9075, 557, 555, 2, 11, 9, 30006, 30004, 83, "Boost Potion Share", "Shares a potion with up to 4 nearby\\nstoners", 25, 0, 5);
	addLunar3RunesSmallBox(30226, 9075, 563, 555, 2, 2, 9, 30012, 30004, 84, "Fisher Guild Teleport", "Teleports you to the fisher guild", 26, 0, 5);
	addLunar3RunesLargeBox(30234, 9075, 563, 555, 1, 2, 13, 30012, 30004, 85, "Tele Group Fisher\\nGuild", "Teleports stoners to the Fisher\\nGuild", 27, 0, 5);
	addLunar3RunesSmallBox(30242, 9075, 557, 561, 2, 14, 0, 30006, 30010, 85, "Plank Make", "Turn Logs into planks", 28, 16, 5);
	addLunar3RunesSmallBox(30250, 9075, 563, 555, 2, 2, 9, 30012, 30004, 86, "Catweedy Teleport", "Teleports you to Catweedy", 29, 0, 5);
	addLunar3RunesSmallBox(30258, 9075, 563, 555, 2, 2, 14, 30012, 30004, 87, "Tele Group Catweedy", "Teleports stoners to Catweedy", 30, 0, 5);
	addLunar3RunesSmallBox(30266, 9075, 563, 555, 2, 2, 7, 30012, 30004, 88, "Ice Plateau Teleport", "Teleports you to Ice Plateau", 31, 0, 5);
	addLunar3RunesBigBox(30274, 9075, 563, 555, 2, 2, 15, 30012, 30004, 89, "Tele Group Ice\\n Plateau", "Teleports stoners to Ice Plateau", 32, 0, 5);
	addLunar3RunesBigBox(30282, 9075, 563, 561, 2, 1, 0, 30012, 30010, 90, "Energy Transfer", "Spend life and SA Energy to\\n give another stoner life and run energy", 33, 8, 2);
	addLunar3RunesBigBox(30290, 9075, 563, 565, 2, 2, 0, 30012, 30014, 91, "Heal Other", "Transfer up to 75% of life\\n to another stoner", 34, 8, 2);
	addLunar3RunesBigBox(30298, 9075, 560, 557, 2, 1, 9, 30009, 30006, 92, "Vengeance Other", "Allows another stoner to rebound\\ndamage to an opponent", 35, 8, 2);
	addLunar3RunesSmallBox(30306, 9075, 560, 557, 3, 1, 9, 30009, 30006, 93, "Vengeance", "Rebound damage to an opponent", 36, 0, 5);
	addLunar3RunesBigBox(30314, 9075, 565, 563, 3, 2, 5, 30014, 30012, 94, "Heal Group", "Transfer up to 75% of life to a group", 37, 0, 5);
	...
	public static void addNecromance(int i, int configId, int configFrame, int requiredValues, int necromanceSpriteID, String NecromanceName, int Hover) {
	...
	public static void addNecromanceWithTooltip(int i, int configId, int configFrame, int requiredValues, int necromanceSpriteID, int Hover, String tooltip) {
	RSInterface Interface = addTabInterface(i);
	Interface.id = i;
	...
	public static void ancientMageTab() {
	...
	addBankHover(21000, 4, 21001, 7, 8, "Interfaces/Bank/BANK", 35, 25, 304, 1, "Swap Withdraw Mode", 21002, 7, 8, "Interfaces/Bank/BANK", 21003, "Switch to insert items \nmode", "Switch to swap items \nmode.", 12, 20);
	...
	addTooltip(22548, "Grade 54\nSap Mage\nDrains 10% of enemy Mage\nand Aegis, increasing to 20%\nover time");
	addTooltip(22550, "Grade 56\nSap Spirit\nDrains enenmy special assault\nenergy");
	addTooltip(22552, "Grade 59\nBerserker\nBoosted stats last 15% longer");
	addTooltip(22554, "Grade 62\nDeflect Summoning\nReduces damage dealt from\nSummoning scrolls, prevents the\nuse of a familiar's special\nassault, and can deflect some of\ndamage back to the assaulter");
	addTooltip(22556, "Grade 65\nDeflect Mage\nProtects against mageal assaults\nand can deflect some of the\ndamage back to the assaulter");
	addTooltip(22558, "Grade 68\nDeflect Missiles\nProtects against sagittarius assaults\nand can deflect some of the\ndamage back to the assaulter");
	addTooltip(22560, "Grade 71\nDeflect Melee\nProtects against melee assaults\nand can deflect some of the\ndamage back to the assaulter");
	addTooltip(22562, "Grade 74\nLeech Assault\nBoosts Assault by 5%, increasing\nto 10% over time, while draining\nenemy Assault by 10%, increasing\nto 25% over time");
	addTooltip(22564, "Grade 76\nLeech Sagittarius\nBoosts Sagittarius by 5%, increasing\nto 10% over time, while draining\nenemy Sagittarius by 10%,\nincreasing to 25% over\ntime");
	addTooltip(22566, "Grade 78\nLeech Mage\nBoosts Mage by 5%, increasing\nto 10% over time, while draining\nenemy Mage by 10%, increasing\nto 25% over time");
	addTooltip(22568, "Grade 80\nLeech Aegis\nBoosts Aegis by 5%, increasing\nto 10% over time, while draining\n enemy Aegis by10%,\nincreasing to 25% over\ntime");
	addTooltip(22570, "Grade 82\nLeech Vigour\nBoosts Vigour by 5%, increasing\nto 10% over time, while draining\nenemy Vigour by 10%, increasing\n to 25% over time");
	addTooltip(22572, "Grade 84\nLeech Energy\nDrains enemy run energy, while\nincreasing your own");
	addTooltip(22574, "Grade 86\nLeech Special Assault\nDrains enemy special assault\nenergy, while increasing your\nown");
	addTooltip(22576, "Grade 89\nWrath\nInflicts damage to nearby\ntargets if you die");
	addTooltip(22578, "Grade 92\nSoul Split\n1/4 of damage dealt is also removed\nfrom opponent's Necromance and\nadded to your Life");
	addTooltip(22580, "Grade 95\nTurmoil\nIncreases Assault and Aegis\nby 15%, plus 15% of enemy's\ngrade, and Vigour by 23% plus\n10% of enemy's grade");
	...
	for (int i1 = 0; i1 < spellButton.length; i1++) {
		...
		addButton(1195, 1, "Interfaces/Mage/Home", "Cast @gre@Home Teleport");
	...
	addButton(25810, 5, -1, 3, 4, "Interfaces/OptionTab/OPTION", 32, 32, "Adjust Music Grade", 168, 4);
	...
	addButton(25834, 4, 25835, 9, 10, "Interfaces/OptionTab/OPTION", 40, 40, "Toggle Split-Grade Chat", 287, 0);
	addTooltip(25835, "Toggle Split-Grade Chat");
	...
	prayIndex++;
	addNecromanceWithTooltip(25030, 0, 94, 33, prayIndex, 25082, "Activate @lre@Incredible Reflexes");
	prayIndex++;
	addNecromanceWithTooltip(25032, 0, 95, 36, prayIndex, 25084, "Activate @lre@Protect from Mage");
	prayIndex++;
	addNecromanceWithTooltip(25034, 0, 96, 39, prayIndex, 25086, "Activate @lre@Protect from Missles");
	prayIndex++;
	addNecromanceWithTooltip(25036, 0, 97, 42, prayIndex, 25088, "Activate @lre@Protect from Melee");
	prayIndex++;
	...
	addTooltip(25056, "Grade 07\nClarity of Thought\nIncreases your Assault by 5%");
	addTooltip(25058, "Grade 08\nSharp Eye\nIncreases your Sagittarius by 5%");
	addTooltip(25060, "Grade 09\nMystic Will\nIncreases your Mage by 5%");
	addTooltip(25062, "Grade 10\nRock Skin\nIncreases your Aegis by 10%");
	addTooltip(25064, "Grade 13\nSuperhuman Vigour\nIncreases your Vigour by 10%");
	addTooltip(25066, "Grade 16\nImproved Reflexes\nIncreases your Assault by 10%");
	addTooltip(25068, "Grade 19\nRapid Restore\n2x restore rate for all stats\nexcept Life, Summoning\nand Necromance");
	...
	addTooltip(25076, "Grade 27\nMystic Lore\nIncreases your Mage by 10%");
	addTooltip(25078, "Grade 28\nSteel Skin\nIncreases your Aegis by 15%");
	addTooltip(25080, "Grade 31\nUltimate Vigour\nIncreases your Vigour by 15%");
	addTooltip(25082, "Grade 34\nIncredible Reflexes\nIncreases your Assault by 15%");
	addTooltip(25084, "Grade 37\nProtect from Mage\nProtection from mageal assaults");
	addTooltip(25086, "Grade 40\nProtect from Missles\nProtection from sagittarius assaults");
	addTooltip(25088, "Grade 43\nProtect from Melee\nProtection from melee assaults");
	addTooltip(25090, "Grade 44\nEagle Eye\nIncreases your Sagittarius by 15%");
	addTooltip(25092, "Grade 45\nMystic Might\nIncreases your Mage by 15%");
	addTooltip(25094, "Grade 46\nRetribution\nInflicts damage to nearby\ntargets if you die");
	addTooltip(25096, "Grade 49\nRedemption\nHeals you when damaged\nand Life falls\nbelow 10%");
	addTooltip(25098, "Grade 52\nSmite\n1/4 of damage dealt is\nalso removed from\nopponent's Necromance");
	addTooltip(25100, "Grade 60\nChivalry\nIncreases your Aegis by 20%,\nVigour by 18%, and Assault by\n15%");
	addTooltip(25102, "Grade 70\nPiety\nIncreases your Aegis by 25%,\nVigour by 23%, and Assault by\n20%");
	...
	addHoverButton(17231, "/Interfaces/QuickNecromance/Sprite", 4, 190, 24, "Confirm Selection", -1, 17232, 1);
	...
	addHoverButton(29817, "Interfaces/RingofKinship/inspect", 0, 72, 64, "inspect @or1@Ring of Kinship", -1, 29818, 1);
	addHoveredButton(29818, "Interfaces/RingofKinship/inspect", 0, 72, 64, 29819);
	addHoverButton(29820, "Interfaces/RingofKinship/inspect", 0, 72, 64, "inspect @or1@Ring of Kinship", -1, 29821, 1);
	addHoveredButton(29821, "Interfaces/RingofKinship/inspect", 0, 72, 64, 29822);
	addHoverButton(29823, "Interfaces/RingofKinship/inspect", 0, 72, 64, "inspect @or1@Ring of Kinship", -1, 29824, 1);
	addHoveredButton(29824, "Interfaces/RingofKinship/inspect", 0, 72, 64, 29825);
	addHoverButton(29826, "Interfaces/RingofKinship/inspect", 0, 72, 64, "inspect @or1@Ring of Kinship", -1, 29827, 1);
	addHoveredButton(29827, "Interfaces/RingofKinship/inspect", 0, 72, 64, 29828);
	...
	Sidebar0a(1698, 1701, 7499, "Chop", "Hack", "Smash", "Block", 42, 75, 127, 75, 39, 128, 125, 128, 122, 103, 40, 50, 122, 50, 40, 103);
	Sidebar0a(2276, 2279, 7574, "Stab", "Lunge", "Slash", "Block", 43, 75, 124, 75, 41, 128, 125, 128, 122, 103, 40, 50, 122, 50, 40, 103);
	Sidebar0a(2423, 2426, 7599, "Chop", "Slash", "Lunge", "Block", 42, 75, 125, 75, 40, 128, 125, 128, 122, 103, 40, 50, 122, 50, 40, 103);
	Sidebar0a(3796, 3799, 7624, "Pound", "Pummel", "Spike", "Block", 39, 75, 121, 75, 41, 128, 125, 128, 122, 103, 40, 50, 122, 50, 40, 103);
	Sidebar0a(4679, 4682, 7674, "Lunge", "Swipe", "Pound", "Block", 40, 75, 124, 75, 39, 128, 125, 128, 122, 103, 40, 50, 122, 50, 40, 103);
	Sidebar0a(4705, 4708, 7699, "Chop", "Slash", "Smash", "Block", 42, 75, 125, 75, 39, 128, 125, 128, 122, 103, 40, 50, 122, 50, 40, 103);
	Sidebar0a(5570, 5573, 7724, "Spike", "Impale", "Smash", "Block", 41, 75, 123, 75, 39, 128, 125, 128, 122, 103, 40, 50, 122, 50, 40, 103);
	Sidebar0a(7762, 7765, 7800, "Chop", "Slash", "Lunge", "Block", 42, 75, 125, 75, 40, 128, 125, 128, 122, 103, 40, 50, 122, 50, 40, 103);
	Sidebar0b(776, 779, "Reap", "Chop", "Jab", "Block", 42, 75, 126, 75, 46, 128, 125, 128, 122, 103, 122, 50, 40, 103, 40, 50);
	Sidebar0c(425, 428, 7474, "Pound", "Pummel", "Block", 39, 75, 121, 75, 42, 128, 40, 103, 40, 50, 122, 50);
	Sidebar0c(1749, 1752, 7524, "Accurate", "Rapid", "Longrange", 33, 75, 125, 75, 29, 128, 40, 103, 40, 50, 122, 50);
	Sidebar0c(1764, 1767, 7549, "Accurate", "Rapid", "Longrange", 33, 75, 125, 75, 29, 128, 40, 103, 40, 50, 122, 50);
	Sidebar0c(4446, 4449, 7649, "Accurate", "Rapid", "Longrange", 33, 75, 125, 75, 29, 128, 40, 103, 40, 50, 122, 50);
	...
	textSize(3983, 0);
	addToggleButton(150, 150, 172, 150, 44, "LAZY MODE");
	...
	addSprite(22603, 0, "Interfaces/summoning/cons2/upgrade");
	...
	addHoverButton(17018, "Interfaces/SummonTab/SUMMON", 2, 38, 36, "Beast of burden Box", -1, 17028, 1);
	...
	do {
		...
		if (rsInterface.mouseOverPopupInterface != 0)
			rsInterface.mouseOverPopupInterface = (rsInterface.mouseOverPopupInterface - 1 << 8) + byteVector.readUnsignedByte();
		else
			rsInterface.mouseOverPopupInterface = -1;
