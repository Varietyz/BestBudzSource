...
public final class RSInterface {
  ...
  public static void addHDHoverButton(
      int i,
      String imageName,
      int j,
      int width,
  ...
  public static void addInAreaHover(
      int i,
      String imageName,
      int sId,
      int sId2,
  ...
  public static void addLunar2RunesSmallBox(
      int ID,
      int r1,
      int r2,
      int ra1,
  ...
  public static void addLunar3RunesBigBox(
      int ID,
      int r1,
      int r2,
      int r3,
  ...
  public static void addLunar3RunesLargeBox(
      int ID,
      int r1,
      int r2,
      int r3,
  ...
  public static void addLunar3RunesSmallBox(
      int ID,
      int r1,
      int r2,
      int r3,
  ...
  public static void configureLunar() {
    ...
    addLunar3RunesSmallBox(
        ...
        5);
    addLunar3RunesSmallBox(
        30091, 9075, 564, 563, 1, 1, 0, 30013, 30012, 70, "Cure Me", "Cures Poison", 9, 0, 5);
    addLunar2RunesSmallBox(
        30099, 9075, 557, 1, 1, 30006, 70, "Hunter Kit", "Get a kit of hunting gear", 10, 0, 5);
    addLunar3RunesSmallBox(
        30106,
        9075,
        563,
    ...
    addLunar3RunesSmallBox(
        ...
        78,
        "Tele Group Khazard",
        "Teleports stoners to Port khazard",
        19,
        0,
        5);
    addLunar3RunesBigBox(
    ...
    addLunar3RunesSmallBox(
        ...
        30004,
        84,
        "Fisher Guild Teleport",
        "Teleports you to the fisher guild",
        26,
        0,
        5);
    addLunar3RunesLargeBox(
    ...
    addLunar3RunesBigBox(
        ...
        89,
        "Tele Group Ice\\n Plateau",
        "Teleports stoners to Ice Plateau",
        32,
        0,
        5);
    addLunar3RunesBigBox(
        ...
        90,
        "Energy Transfer",
        "Spend life and SA Energy to\\n give another stoner life and run energy",
        33,
        8,
        2);
    addLunar3RunesBigBox(
    ...
    addLunar3RunesBigBox(
        ...
        94,
        "Heal Group",
        "Transfer up to 75% of life to a group",
        37,
        0,
        5);
    addLunar3RunesBigBox(
  ...
  public static void addActionButton(
      int id, int sprite, int sprite2, int width, int height, String s) {
  ...
  public static void addAssaultStyleButton2(
      int id,
      int sprite,
      int setconfig,
      int width,
  ...
  public static void addConfigButton(
      int ID,
      int pID,
      int bID,
      int bID2,
  ...
  public static void Buy() {
    ...
    addHoverButton(
        24606, "Interfaces/GrandExchange/sprite", 1, 13, 13, "Decrease Quantity", 0, 24607, 1);
    addHoveredButton(24607, "Interfaces/GrandExchange/sprite", 3, 13, 13, 24608);
    addHoverButton(
        24610, "Interfaces/GrandExchange/sprite", 2, 13, 13, "Increase Quantity", 0, 24611, 1);
    ...
    addHoverButton(
        24630, "Interfaces/GrandExchange/sprite", 13, 35, 25, "Edit Quantity", 7712, 24631, 1);
    addHoveredButton(24631, "Interfaces/GrandExchange/sprite", 14, 35, 25, 24632);
    addHoverButton(
        24634, "Interfaces/GrandExchange/sprite", 15, 35, 25, "Decrease Price", 0, 24635, 1);
    addHoveredButton(24635, "Interfaces/GrandExchange/sprite", 16, 35, 25, 24636);
    addHoverButton(
        24638, "Interfaces/GrandExchange/sprite", 17, 35, 25, "Offer Guild Price", 0, 24639, 1);
    addHoveredButton(24639, "Interfaces/GrandExchange/sprite", 18, 35, 25, 24640);
    addHoverButton(
        24642, "Interfaces/GrandExchange/sprite", 13, 35, 25, "Edit Price", 7714, 24643, 1);
    addHoveredButton(24643, "Interfaces/GrandExchange/sprite", 14, 35, 25, 24644);
    addHoverButton(
        24646, "Interfaces/GrandExchange/sprite", 19, 35, 25, "Increase Price", 0, 24647, 1);
    addHoveredButton(24647, "Interfaces/GrandExchange/sprite", 20, 35, 25, 24648);
    addHoverButton(
        24650, "Interfaces/GrandExchange/sprite", 21, 120, 43, "Confirm Offer", 0, 24651, 1);
    addHoveredButton(24651, "Interfaces/GrandExchange/sprite", 22, 120, 43, 24652);
    addHoverButton(
        1, 24654, "Interfaces/GrandExchange/sprite", 23, 40, 36, "Choose Item", 0, 24655, 1);
    ...
    addHoverButton(
        24662, "Interfaces/GrandExchange/sprite", 1, 13, 13, "Decrease Price", 0, 24663, 1);
    addHoveredButton(24663, "Interfaces/GrandExchange/sprite", 3, 13, 13, 24664);
    addHoverButton(
        24665, "Interfaces/GrandExchange/sprite", 2, 13, 13, "Increase Price", 0, 24666, 1);
  ...
  public static void emoteTab() {
    ...
    tab.child(0, 148, 0, 1);
    int[] ButtonIDs = {
      168, 169, 164, 165, 162, 163, 13370, 171, 167, 170, 13366, 13368, 166, 13363, 13364, 13365,
      161, 11100, 13362, 13367, 172, 13369, 13383, 13384, 667, 6503, 6506, 666, 18464, 18465, 15166,
      18686, 18689, 18688, 18691, 18692, 18687, 154, 22586, 22587, 22588, 22589, 22590, 22591,
      22592, 22593, 22594
    };
    int[] EmoteX = {
      10, 54, 98, 137, 9, 48, 95, 132, 7, 51, 95, 139, 6, 50, 90, 135, 8, 51, 99, 137, 10, 53, 85,
      138, 3, 52, 96, 141, 5, 53, 88, 142, 10, 51, 139, 88, 12, 49, 97, 135, 10, 50, 90, 130, 10,
      60, 90
    };
    int[] EmoteY = {
      6, 6, 8, 6, 55, 55, 55, 55, 104, 104, 103, 104, 153, 153, 153, 153, 203, 202, 203, 202, 250,
      250, 252, 249, 300, 299, 299, 299, 349, 350, 352, 350, 401, 402, 406, 402, 452, 450, 452, 452,
  ...
  public static int getParent(int id) {
    if (interfaceCache[id] == null
        || interfaceCache[id].parentID == -1
        || interfaceCache[id].parentID == id) return id;
    else return getParent(interfaceCache[id].parentID);
  }
  ...
  public static void mageTab() {
    ...
    int[] spellButton = {
      1196, 1199, 1206, 1215, 1224, 1231, 1240, 1249, 1258, 1267, 1274, 1283, 1573, 1290, 1299,
      1308, 1315, 1324, 1333, 1340, 1349, 1358, 1367, 1374, 1381, 1388, 1397, 1404, 1583, 12038,
      1414, 1421, 1430, 1437, 1446, 1453, 1460, 1469, 15878, 1602, 1613, 1624, 7456, 1478, 1485,
      1494, 1503, 1512, 1521, 1530, 1544, 1553, 1563, 1593, 1635, 12426, 12436, 12446, 12456, 6004,
      18471
    };
    ...
    for (int i2 = 0; i2 < spellButton.length; i2++) {
      ...
      if (i2 == 6 || i2 == 12 || i2 == 19 || i2 == 35 || i2 == 41 || i2 == 44 || i2 == 49
          || i2 == 51) spellButtons.childX[i2] = 0;
  ...
  public static void optionTab() {
    ...
    addButton(
        25805, 5, -1, 2, 2, "Interfaces/OptionTab/OPTION", 32, 32, "Adjust Brightness", 166, 1);
    ...
    addButton(
        25810, 5, -1, 3, 4, "Interfaces/OptionTab/OPTION", 32, 32, "Adjust Music Grade", 168, 4);
    ...
    addButton(
        25822, 5, -1, 7, 8, "Interfaces/OptionTab/OPTION", 32, 32, "Adjust Sound Effects", 400, 0);
    ...
    addButton(
        ...
        40,
        40,
        "Toggle Split-Grade Chat",
        287,
        0);
    addTooltip(25835, "Toggle Split-Grade Chat");
    addButton(
        25837, 4, 25838, 9, 10, "Interfaces/OptionTab/OPTION", 40, 40, "Toggle Accept Aid", 427, 0);
    addTooltip(25838, "Toggle Accept Aid");
    addButton(
        152, 4, 25841, 9, 10, "Interfaces/OptionTab/OPTION", 40, 40, "Toggle Run Mode", 173, 1);
    addTooltip(25841, "Toggle Run-Mode");
    addButton(
        25842, 4, 25843, 9, 10, "Interfaces/OptionTab/OPTION", 40, 40, "More Options", 175, 1);
    ...
    try {
      ...
      while ((line = reader.readLine()) != null) {
        ...
        try {
          ...
          id =
              Integer.parseInt(line.substring(line.indexOf("id: ") + 3, line.indexOf(" n")).trim());
  ...
  public static void pouchCreation() {
    ...
    for (int i = 0; i < totalScrolls; i++) {
      addInAreaHover(
          23479 + i * 8, "Interfaces/summoning/creation/box", 0, 1, 48, 52, "nothing", -1, 0);
      int[] req = {1, 2, 3};
      addPouch(
          23480 + i * 8, req, 1, pouchItems[i], summoningGradeRequirements[i], pouchNames[i], i, 5);
  ...
  public static void RingColourChange() {
    ...
    addHoverButton(
        29817,
        "Interfaces/RingofKinship/inspect",
        0,
        72,
        64,
        "inspect @or1@Ring of Kinship",
        -1,
        29818,
        1);
  ...
  public static void scrollCreation() {
    ...
    for (int i = 0; i < totalScrolls; i++) {
      addInAreaHover(
          22768 + i * 9, "Interfaces/summoning/creation/box", 0, 1, 48, 52, "nothing", -1, 0);
      addScroll(
          22769 + i * 9,
          pouchItems[i],
          1,
          scrollItems[i],
          summoningGradeRequirements[i],
          scrollNames[i],
          i,
          5);
  ...
  public static void Sell() {
    ...
    addHoverButton(
        24706, "Interfaces/GrandExchange/sprite", 1, 13, 13, "Decrease Quantity", 0, 24707, 1);
    addHoveredButton(24707, "Interfaces/GrandExchange/sprite", 3, 13, 13, 24708);
    addHoverButton(
        24710, "Interfaces/GrandExchange/sprite", 2, 13, 13, "Increase Quantity", 0, 24711, 1);
    ...
    addHoverButton(
        24730, "Interfaces/GrandExchange/sprite", 13, 35, 25, "Edit Quantity", 7713, 24731, 1);
    addHoveredButton(24731, "Interfaces/GrandExchange/sprite", 14, 35, 25, 24732);
    addHoverButton(
        24734, "Interfaces/GrandExchange/sprite", 15, 35, 25, "Decrease Price", 0, 24735, 1);
    addHoveredButton(24735, "Interfaces/GrandExchange/sprite", 16, 35, 25, 24736);
    addHoverButton(
        24738, "Interfaces/GrandExchange/sprite", 17, 35, 25, "Offer Guild Price", 0, 24739, 1);
    addHoveredButton(24739, "Interfaces/GrandExchange/sprite", 18, 35, 25, 24740);
    addHoverButton(
        24742, "Interfaces/GrandExchange/sprite", 13, 35, 25, "Edit Price", 7715, 24743, 1);
    addHoveredButton(24743, "Interfaces/GrandExchange/sprite", 14, 35, 25, 24744);
    addHoverButton(
        24746, "Interfaces/GrandExchange/sprite", 19, 35, 25, "Increase Price", 0, 24747, 1);
    addHoveredButton(24747, "Interfaces/GrandExchange/sprite", 20, 35, 25, 24748);
    addHoverButton(
        24750, "Interfaces/GrandExchange/sprite", 21, 120, 43, "Confirm Offer", 0, 24751, 1);
    ...
    addHoverButton(
        24762, "Interfaces/GrandExchange/sprite", 1, 13, 13, "Decrease Price", 0, 24763, 1);
    addHoveredButton(24763, "Interfaces/GrandExchange/sprite", 3, 13, 13, 24764);
    addHoverButton(
        24765, "Interfaces/GrandExchange/sprite", 2, 13, 13, "Increase Price", 0, 24766, 1);
  ...
  public static void settingsInterface() {
    ...
    addButton(
        26007, 4, -1, 2, 3, "Interfaces/settings/click", 15, 15, "Toggle function keys", 650, 1);
  ...
  public static void Sidebar0() {
    Sidebar0a(
        1698, 1701, 7499, "Chop", "Hack", "Smash", "Block", 42, 75, 127, 75, 39, 128, 125, 128, 122,
        103, 40, 50, 122, 50, 40, 103);
    Sidebar0a(
        2276, 2279, 7574, "Stab", "Lunge", "Slash", "Block", 43, 75, 124, 75, 41, 128, 125, 128,
        122, 103, 40, 50, 122, 50, 40, 103);
    Sidebar0a(
        2423, 2426, 7599, "Chop", "Slash", "Lunge", "Block", 42, 75, 125, 75, 40, 128, 125, 128,
        122, 103, 40, 50, 122, 50, 40, 103);
    Sidebar0a(
        3796, 3799, 7624, "Pound", "Pummel", "Spike", "Block", 39, 75, 121, 75, 41, 128, 125, 128,
        122, 103, 40, 50, 122, 50, 40, 103);
    Sidebar0a(
        4679, 4682, 7674, "Lunge", "Swipe", "Pound", "Block", 40, 75, 124, 75, 39, 128, 125, 128,
        122, 103, 40, 50, 122, 50, 40, 103);
    Sidebar0a(
        4705, 4708, 7699, "Chop", "Slash", "Smash", "Block", 42, 75, 125, 75, 39, 128, 125, 128,
        122, 103, 40, 50, 122, 50, 40, 103);
    Sidebar0a(
        5570, 5573, 7724, "Spike", "Impale", "Smash", "Block", 41, 75, 123, 75, 39, 128, 125, 128,
        122, 103, 40, 50, 122, 50, 40, 103);
    Sidebar0a(
        7762, 7765, 7800, "Chop", "Slash", "Lunge", "Block", 42, 75, 125, 75, 40, 128, 125, 128,
        122, 103, 40, 50, 122, 50, 40, 103);
    Sidebar0b(
        776, 779, "Reap", "Chop", "Jab", "Block", 42, 75, 126, 75, 46, 128, 125, 128, 122, 103, 122,
        50, 40, 103, 40, 50);
    Sidebar0c(
        425, 428, 7474, "Pound", "Pummel", "Block", 39, 75, 121, 75, 42, 128, 40, 103, 40, 50, 122,
        50);
    Sidebar0c(
        1749,
        1752,
    ...
    Sidebar0c(
        ...
        50);
    Sidebar0c(
        5855, 5857, 7749, "Punch", "Kick", "Block", 40, 75, 129, 75, 42, 128, 40, 50, 122, 50, 40,
        103);
    Sidebar0c(
        6103, 6132, 6117, "Bash", "Pound", "Block", 43, 75, 124, 75, 42, 128, 40, 103, 40, 50, 122,
        50);
    Sidebar0c(
        8460, 8463, 8493, "Jab", "Swipe", "Fend", 46, 75, 124, 75, 43, 128, 40, 103, 40, 50, 122,
        50);
    Sidebar0c(
        12290, 12293, 12323, "Flick", "Lash", "Deflect", 44, 75, 127, 75, 36, 128, 40, 50, 40, 103,
        122, 50);
    Sidebar0d(
        328, 331, "Bash", "Pound", "Focus", 42, 66, 39, 101, 41, 136, 40, 120, 40, 50, 40, 85);
  ...
  public static void professionInterface() {
    ...
    addButton(
        ...
        62,
        32,
        "@lre@Dismiss Summoning Familiar@whi@",
        1);
  ...
  public static void SummonTab() {
    ...
    addConfigButton(
        17015, 17032, 14, 8, "Interfaces/SummonTab/SUMMON", 20, 30, "Firmiliar Special", 1, 5, 300);
    addHoverButton(
        17018, "Interfaces/SummonTab/SUMMON", 2, 38, 36, "Beast of burden Box", -1, 17028, 1);
    ...
    addHoverButton(
        17023, "Interfaces/SummonTab/SUMMON", 3, 38, 36, "Dismiss Familiar", -1, 17033, 1);
  ...
  public void specialBar(int id) {
    ...
    for (int i = 13; i < 23; i++) rsi.childY[i]--;
