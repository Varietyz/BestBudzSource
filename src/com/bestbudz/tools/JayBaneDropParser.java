...
public class JayBaneDropParser {
	...
	drops.add(new ItemDrop(268, 4, 4, Rarity.COMMON)); // Girl Scout Cookies
	...
	drops.add(new ItemDrop(995, 529, 4000, Rarity.COMMON)); // BestBucks
	...
	drops.add(new ItemDrop(2434, 1, 1, Rarity.UNCOMMON)); // Power of the necromancer(4)
