...
public class IkushzDropParser {
	...
	drops.add(new ItemDrop(995, 600, 4000, Rarity.COMMON)); // BestBucks
	...
	drops.add(new ItemDrop(2434, 1, 1, Rarity.COMMON)); // Power of the necromancer(4)
	drops.add(new ItemDrop(246, 10, 10, Rarity.COMMON)); // Wine of zamorak

	drops.add(new ItemDrop(995, 3000, 3000, Rarity.COMMON));// BestBucks
	...
	drops.add(new ItemDrop(2482, 4, 4, Rarity.UNCOMMON)); // Super Silver Haze
