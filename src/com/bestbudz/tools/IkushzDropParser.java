...
import com.bestbudz.tools.IkushzDropParser.ItemDrop.Rarity;

public class IkushzDropParser {
  ...
  public static void main(String[] args) throws IOException {
    ...
    drops.add(new ItemDrop(4697, 30, 30, Rarity.COMMON));
    drops.add(new ItemDrop(995, 600, 4000, Rarity.COMMON));
    drops.add(new ItemDrop(1624, 4, 4, Rarity.COMMON));
    drops.add(new ItemDrop(1622, 6, 6, Rarity.COMMON));
    drops.add(new ItemDrop(2298, 8, 8, Rarity.COMMON));
    drops.add(new ItemDrop(7946, 1, 1, Rarity.COMMON));
    drops.add(new ItemDrop(7946, 1, 1, Rarity.COMMON));
    drops.add(new ItemDrop(7946, 1, 1, Rarity.COMMON));
    drops.add(new ItemDrop(385, 1, 1, Rarity.COMMON));
    drops.add(new ItemDrop(1452, 1, 1, Rarity.COMMON));
    drops.add(new ItemDrop(1462, 1, 1, Rarity.COMMON));
    drops.add(new ItemDrop(7937, 250, 250, Rarity.COMMON));
    drops.add(new ItemDrop(2434, 1, 1, Rarity.COMMON));
    drops.add(new ItemDrop(246, 10, 10, Rarity.COMMON));
    ...
    drops.add(new ItemDrop(1033, 1, 1, Rarity.UNCOMMON));
    drops.add(new ItemDrop(1035, 1, 1, Rarity.UNCOMMON));
    drops.add(new ItemDrop(1391, 1, 1, Rarity.UNCOMMON));
    drops.add(new ItemDrop(2570, 1, 1, Rarity.UNCOMMON));
    drops.add(new ItemDrop(3387, 1, 1, Rarity.UNCOMMON));
    drops.add(new ItemDrop(3389, 1, 1, Rarity.UNCOMMON));
    drops.add(new ItemDrop(554, 250, 250, Rarity.UNCOMMON));
    drops.add(new ItemDrop(562, 175, 175, Rarity.UNCOMMON));
    drops.add(new ItemDrop(565, 50, 50, Rarity.UNCOMMON));
    drops.add(new ItemDrop(2482, 4, 4, Rarity.UNCOMMON));
    drops.add(new ItemDrop(993, 1, 1, Rarity.UNCOMMON));
    drops.add(new ItemDrop(12746, 1, 1, Rarity.UNCOMMON));
    drops.add(new ItemDrop(4675, 1, 1, Rarity.RARE));
    drops.add(new ItemDrop(11928, 1, 1, Rarity.RARE));
    drops.add(new ItemDrop(11931, 1, 1, Rarity.RARE));
    drops.add(new ItemDrop(11995, 1, 1, Rarity.RARE));
