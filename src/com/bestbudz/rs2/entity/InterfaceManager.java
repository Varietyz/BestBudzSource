...
public class InterfaceManager {
  ...
  private final int[] tabs = new int[StonerConstants.SIDEBAR_INTERFACE_IDS.length];
  ...
  public int[] getParents(int id) {
    ...
    while ((parent != 0) && (c != 24)) {
      if ((RSInterface.interfaceCache[parent] == null)
          || (RSInterface.interfaceCache[parent].parentID == 0)
