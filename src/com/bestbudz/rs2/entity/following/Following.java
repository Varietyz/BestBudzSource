...
public abstract class Following {
	...
	boolean projectile = (entity.getCombat().getCombatType() == CombatTypes.SAGITTARIUS) || (entity.getCombat().getCombatType() == CombatTypes.MAGE);
	...
	int[][] nodes = { { x + com.bestbudz.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[0]][0], y + com.bestbudz.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[0]][1] }, { x + com.bestbudz.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[1]][0], y + com.bestbudz.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[1]][1] }, { x + com.bestbudz.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[2]][0], y + com.bestbudz.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[2]][1] }, { x + com.bestbudz.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[3]][0], y + com.bestbudz.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[3]][1] } };
