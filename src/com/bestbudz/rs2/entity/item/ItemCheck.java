...
public class ItemCheck {
  ...
  public static boolean hasIronArmour(Stoner stoner) {
    if (stoner.getBox().hasItemId(12810)
        || stoner.getBox().hasItemId(12811)
        || stoner.getBox().hasItemId(12812)) {
      return true;
    }
    if (stoner.getBank().hasItemId(12810)
        || stoner.getBank().hasItemId(12811)
        || stoner.getBank().hasItemId(12812)) {
      return true;
    }
    return stoner.getEquipment().contains(12810)
        || stoner.getEquipment().contains(12811)
        || stoner.getEquipment().contains(12812);
  }

  public static boolean hasUltimateArmour(Stoner stoner) {
    if (stoner.getBox().hasItemId(12813)
        || stoner.getBox().hasItemId(12814)
        || stoner.getBox().hasItemId(12815)) {
      return true;
    }
    if (stoner.getBank().hasItemId(12813)
        || stoner.getBank().hasItemId(12814)
        || stoner.getBank().hasItemId(12815)) {
      return true;
    }
    return stoner.getEquipment().contains(12813)
        || stoner.getEquipment().contains(12814)
        || stoner.getEquipment().contains(12815);
  }

  public static boolean hasGodCape(Stoner stoner) {
    if (stoner.getBox().hasItemId(2412)
        || stoner.getBox().hasItemId(2413)
        || stoner.getBox().hasItemId(2414)) {
      return true;
    }
    if (stoner.getBank().hasItemId(2412)
        || stoner.getBank().hasItemId(2413)
        || stoner.getBank().hasItemId(2414)) {
      return true;
    }
    return stoner.getEquipment().contains(2412)
        || stoner.getEquipment().contains(2413)
        || stoner.getEquipment().contains(2414);
  }
  ...
  public static boolean hasDFireShield(Stoner p) {
    return (p.getEquipment().getItems()[5] != null)
        && (p.getEquipment().getItems()[5].getId() == 11283);
  }
  ...
  public static boolean isUsingBalmung(Stoner p) {
    return (p.getEquipment().getItems()[3] != null)
        && (p.getEquipment().getItems()[3].getId() == 15403);
  }
