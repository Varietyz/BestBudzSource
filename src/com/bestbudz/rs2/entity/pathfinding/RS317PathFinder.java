...
public class RS317PathFinder {
	...
	/**
	 * The region for the current pathfinding attempt (Only one pathfinding attempt
	 * should be running at any single moment)
	 */
	...
	while (tail != tileQueueX.size() && tileQueueX.size() < DEFAULT_PATH_LENGTH) {
		...
		if (curX > 0 && curY > 0 && via[curX - 1][curY - 1] == 0 && (getClip(curAbsX - 1, curAbsY - 1, z) & 0x128010e) == 0 && (getClip(curAbsX - 1, curAbsY, z) & 0x1280108) == 0 && (getClip(curAbsX, curAbsY - 1, z) & 0x1280102) == 0) {
			tileQueueX.add(curX - 1);
			tileQueueY.add(curY - 1);
			via[curX - 1][curY - 1] = 3;
		...
		if (curX > 0 && curY < 104 - 1 && via[curX - 1][curY + 1] == 0 && (getClip(curAbsX - 1, curAbsY + 1, z) & 0x1280138) == 0 && (getClip(curAbsX - 1, curAbsY, z) & 0x1280108) == 0 && (getClip(curAbsX, curAbsY + 1, z) & 0x1280120) == 0) {
			tileQueueX.add(curX - 1);
			tileQueueY.add(curY + 1);
			via[curX - 1][curY + 1] = 6;
			cost[curX - 1][curY + 1] = thisCost;
		...
		if (curX < 104 - 1 && curY > 0 && via[curX + 1][curY - 1] == 0 && (getClip(curAbsX + 1, curAbsY - 1, z) & 0x1280183) == 0 && (getClip(curAbsX + 1, curAbsY, z) & 0x1280180) == 0 && (getClip(curAbsX, curAbsY - 1, z) & 0x1280102) == 0) {
			tileQueueX.add(curX + 1);
			tileQueueY.add(curY - 1);
			via[curX + 1][curY - 1] = 9;
			cost[curX + 1][curY - 1] = thisCost;
		...
		if (curX < 104 - 1 && curY < 104 - 1 && via[curX + 1][curY + 1] == 0 && (getClip(curAbsX + 1, curAbsY + 1, z) & 0x12801e0) == 0 && (getClip(curAbsX + 1, curAbsY, z) & 0x1280180) == 0 && (getClip(curAbsX, curAbsY + 1, z) & 0x1280120) == 0) {
			tileQueueX.add(curX + 1);
			tileQueueY.add(curY + 1);
	...
	public static void findRoute(Stoner c, int destX, int destY, boolean moveNear, int xLength, int yLength) {
	Benchmarker.start();
	...
	while (tail != tileQueueX.size() && tileQueueX.size() < pathLength) {
		...
		if (curX > 0 && curY > 0 && via[curX - 1][curY - 1] == 0 && (getClip(curAbsX - 1, curAbsY - 1, c.getLocation().getZ()) & 0x128010e) == 0 && (getClip(curAbsX - 1, curAbsY, c.getLocation().getZ()) & 0x1280108) == 0 && (getClip(curAbsX, curAbsY - 1, c.getLocation().getZ()) & 0x1280102) == 0) {
			tileQueueX.add(curX - 1);
			tileQueueY.add(curY - 1);
			via[curX - 1][curY - 1] = 3;
			cost[curX - 1][curY - 1] = thisCost;
		...
		if (curX > 0 && curY < 104 - 1 && via[curX - 1][curY + 1] == 0 && (getClip(curAbsX - 1, curAbsY + 1, c.getLocation().getZ()) & 0x1280138) == 0 && (getClip(curAbsX - 1, curAbsY, c.getLocation().getZ()) & 0x1280108) == 0 && (getClip(curAbsX, curAbsY + 1, c.getLocation().getZ()) & 0x1280120) == 0) {
			tileQueueX.add(curX - 1);
			tileQueueY.add(curY + 1);
			via[curX - 1][curY + 1] = 6;
			cost[curX - 1][curY + 1] = thisCost;
		...
		if (curX < 104 - 1 && curY > 0 && via[curX + 1][curY - 1] == 0 && (getClip(curAbsX + 1, curAbsY - 1, c.getLocation().getZ()) & 0x1280183) == 0 && (getClip(curAbsX + 1, curAbsY, c.getLocation().getZ()) & 0x1280180) == 0 && (getClip(curAbsX, curAbsY - 1, c.getLocation().getZ()) & 0x1280102) == 0) {
			tileQueueX.add(curX + 1);
			tileQueueY.add(curY - 1);
			via[curX + 1][curY - 1] = 9;
			cost[curX + 1][curY - 1] = thisCost;
		...
		if (curX < 104 - 1 && curY < 104 - 1 && via[curX + 1][curY + 1] == 0 && (getClip(curAbsX + 1, curAbsY + 1, c.getLocation().getZ()) & 0x12801e0) == 0 && (getClip(curAbsX + 1, curAbsY, c.getLocation().getZ()) & 0x1280180) == 0 && (getClip(curAbsX, curAbsY + 1, c.getLocation().getZ()) & 0x1280120) == 0) {
			tileQueueX.add(curX + 1);
			tileQueueY.add(curY + 1);
			via[curX + 1][curY + 1] = 12;
			cost[curX + 1][curY + 1] = thisCost;
