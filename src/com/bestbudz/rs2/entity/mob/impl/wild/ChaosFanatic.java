...
public class ChaosFanatic extends Mob {
	...
	private String[] messages = { "Burn!", "WEUGH!", "Develish Oxen Roll!", "All your wilderness are belong to them!", "AhehHeheuhHhahueHuUEehEahAH", "I shall call him squidgy and he shall be my squidgy!", };
		...
		TaskQueue.queue(new Task(stoner, 3, false) {
			...
			if (stoner.getLocation().equals(end)) {
				...
				if (stoner.getEquipment().getItems()[3] != null) {
					...
					stoner.send(new SendMessage("The Chaos Fanatic has removed some of your worn equipment."));
