...
public class CrazyArchaeologist extends Mob {
	...
	private String[] messages = { "I'm Bellock - respect me!", "Get off my site!", "No-one messes with Bellock's dig!", "These ruins are quarry!", "Taste my knowledge!", "You belong in a museum!", };
