...
public enum RandomMobChatting {
	...
	MAKEOVER_MAGE(new int[] { 599, 2676 }, 150, "I can change your appearance.", "Welcome to BestBudz you stoner!"),
	COMBAT_TUTOR(new int[] { 705 }, 120, "Welcome to BestBudz!", "Dont be lazy ya mug, swing that sword!")

	;

	private static final Map<Integer, RandomMobChatting> mobs = new HashMap<Integer, RandomMobChatting>();
