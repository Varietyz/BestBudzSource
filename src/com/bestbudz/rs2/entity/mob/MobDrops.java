...
public class MobDrops {
  ...
  public static void drop(
      Entity entity, Mob mob, ItemDropDefinition.ItemDropTable table, Location dropLocation) {
    if ((table != null) && (table.getDrops() != null)) {
      ...
      if (!entity.isNpc()) {
        if (item.getDefinition().getGeneralPrice() >= 1_000_000) {
          StonerLogger.DROP_LOGGER.log(
              ...
              String.format(
                  "%s has recieved %s %s from %s.",
                  Utility.formatStonerName(entity.getStoner().getUsername()),
                  item.getAmount(),
      ...
      if (!item.getDefinition().isStackable()) {
        if (item.getAmount() > 5) {
          ...
          GroundItemHandler.add(
              item,
              dropLocation,
              (entity == null) || (entity.isNpc()) ? null : World.getStoners()[entity.getIndex()],
              World.getStoners()[entity.getIndex()].getStoner() != null
                  ? World.getStoners()[entity.getIndex()]
                  : null);
        } else {
  ...
  public static void dropConstants(
      Entity entity, Mob mob, ItemDropDefinition.ItemDropTable constants, Location dropLocation) {
  ...
  public static List<Item> getDropConstants(
      Entity entity, ItemDropDefinition.ItemDropTable constants) {
  ...
  public static boolean dropClues(Stoner stoner, Mob mob, Location dropLocation) {
    ...
    if (rand >= chance) {
      ...
      if (grade < 70) {
        item =
            ClueScrollManager.getRandomClue(
                stoner, Math.random() > 0.5 ? ClueDifficulty.MEDIUM : ClueDifficulty.EASY);
      } else if (grade >= 70 && grade < 120) {
        item =
            ClueScrollManager.getRandomClue(
                stoner, Math.random() > 0.5 ? ClueDifficulty.HARD : ClueDifficulty.MEDIUM);
      } else if (grade >= 120) {
      ...
      if (item != null) {
        GroundItemHandler.add(
            item, dropLocation, stoner, stoner.getStoner() != null ? stoner : null);
        return true;
      }
    }
    return false;
  ...
  public static void dropItems(Entity entity, Mob mob) {
    ...
    switch (mob.getId()) {
      ...
      case 467:
        AchievementHandler.activateAchievement(
            stoner, AchievementList.KILL_250_SKELETAL_WYVERNS, 1);
        break;
      ...
      case 2954:
        ...
        AchievementHandler.activateAchievement(
            stoner, AchievementList.EARN_500_MAGE_ARENA_POINTS, 1);
        break;
    }
    ...
    if ((entity != null)
        && (!entity.isNpc())
        && ((p = World.getStoners()[entity.getIndex()]) != null)) {
      ...
      if (mob.getId() == 2463) {
        p.getAttributes()
            .set(
                "CYCLOPS_KILLED",
                p.getAttributes().getInt("CYCLOPS_KILLED") == -1
                    ? 1
                    : p.getAttributes().getInt("CYCLOPS_KILLED") + 1);
        CyclopsRoom.updateInterface(p);
        if (drop) CyclopsRoom.dropDefender(p, mob);
      } else {
        try {
      ...
      if (p.getController().equals(ControllerManager.DEFAULT_CONTROLLER)) {
        ...
        if (random == 75) {
          GroundItemHandler.add(
              new Item(985, 1), dropLocation, p, p.getStoner() != null ? p : null);
        }
        if (random == 100) {
          GroundItemHandler.add(
              new Item(987, 1), dropLocation, p, p.getStoner() != null ? p : null);
        }
      }
    ...
    boolean hasCommon =
        (drops.getCommon() != null)
            && (drops.getCommon().getDrops() != null)
            && (drops.getCommon().getDrops().length > 0);
    boolean hasUncommon =
        (drops.getUncommon() != null)
            && (drops.getUncommon().getDrops() != null)
            && (drops.getUncommon().getDrops().length > 0);
    boolean hasRare =
        (drops.getRare() != null)
            && (drops.getRare().getDrops() != null)
    ...
    for (int i = 0; i < amount; i++) {
      if ((hasUncommon) && (ucTable)) drop(entity, mob, drops.getUncommon(), dropLocation);
      else if (hasCommon) drop(entity, mob, drops.getCommon(), dropLocation);
    }
  }
  ...
  public static List<Item> getDropItems(Stoner stoner, int mob, int mod, boolean raresOnly) {
    ...
    if ((rares)
        && (hasRare)
        && ((rareDrops = getRareDrop(stoner, drops.getRare(), rtMod + mod)) != null)) {
      items.add(rareDrops);
      return items;
    }
    ...
    if (!raresOnly) {
      for (int i = 0; i < amount; i++) {
        if ((hasUncommon) && (ucTable)) items.add(getDrop(stoner, drops.getUncommon()));
        else if (hasCommon) items.add(getDrop(stoner, drops.getCommon()));
      }
    }
    return items;
  }
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < trials; i++) {
      ...
      if (roll >= 500 && roll <= 500 + chance + mod) {
        averages.put(
            new Item(rare.getId()),
            (averages.get(new Item(rare.getId())) == null
                    ? 0
                    : averages.get(new Item(rare.getId())))
                + 1);
      }
    }
    System.out.println();
  ...
  public static boolean rollRareDrop(
      Entity e, Mob mob, ItemDropDefinition.ItemDropTable table, int mod, Location dropLocation) {
    ItemDropDefinition.ItemDrop rare = table.getDrops()[random.nextInt(table.getDrops().length)];
    ...
    if (rare != null) {
      ...
      int roll =
          random.nextInt(
              1000
                  - (p != null && chance < 50
                      ? p.getRareDropEP().getEpAddon() >= 1000
                          ? 600
                          : p.getRareDropEP().getEpAddon()
                      : 0));

      if (roll >= 500 && roll <= 500 + chance + mod) {

        int am =
            rare.getMin() < rare.getMax()
                ? rare.getMin() + random.nextInt(rare.getMax() - rare.getMin())
                : rare.getMin();
        ...
        if (!e.isNpc()) {
          ...
          if (petDrop != null) {
            if (e.getStoner().getActivePets().size() < 5) {
              ...
              AchievementHandler.activateAchievement(
                  e.getStoner(), AchievementList.OBTAIN_10_BOSS_PET, 1);
            }
          } else {
  ...
  public static Item getRareDrop(Entity e, ItemDropDefinition.ItemDropTable table, int mod) {
    ...
    if (rare != null) {
      ...
      int roll =
          random.nextInt(1000 - (p != null && chance < 80 ? p.getRareDropEP().getEpAddon() : 0));
