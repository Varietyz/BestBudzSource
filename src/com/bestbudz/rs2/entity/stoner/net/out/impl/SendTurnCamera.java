...
public class SendTurnCamera extends OutgoingPacket {
	 ...
	 * @param constantSpeed
	 *                          The constant linear camera movement speed as angular
	 *                          units per cycle. In the XY angle there are 2048
	 *                          units in 360 degrees. In the Z angle is restricted
	 *                          between 128 and 383, which are the min and max
	 *                          ZAngle.
	 * @param variableSpeed
	 *                          The variable linear camera movement speed as promile
	 *                          of what's left. Max 99, 100 is instant.
