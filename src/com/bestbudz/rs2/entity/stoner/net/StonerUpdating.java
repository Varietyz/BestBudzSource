...
public final class StonerUpdating {
	...
	public static void addStoner(OutBuffer out, StonerUpdateFlags local, StonerUpdateFlags other, int index) {
	...
	public static void appendPlacement(
		OutBuffer out, int localX, int localY, int z,
	...
	public static void appendRun(OutBuffer out, int direction, int direction2, boolean attributesUpdate) {
	...
	public static void update(Stoner stoner, StonerUpdateFlags[] pFlags) {
		...
		for (Iterator<Stoner> it = stoners.iterator(); it.hasNext();) {
			...
			if (flags != null && flags.isActive() && flags.isVisible() && !flags.isPlacement()
	...
	public static void updateState(
		StonerUpdateFlags flags, StreamBuffer.OutBuffer block, boolean forceAppearance, boolean noChat) {
