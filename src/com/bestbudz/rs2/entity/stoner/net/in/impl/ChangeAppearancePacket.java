...
public class ChangeAppearancePacket extends IncomingPacket {
  ...
  private static final int[][] IDK_COLORS = {
    {
      6798, 107, 10283, 16, 4797, 7744, 5799, 4634, 22433, 2983, 8, 5281, 10438,
      3650, 200, 571, 908, 21830, 28946, 1000, 7114, 6873, 6400,
    ...
    {
      8741, 12, 7735, 8404, 1701, 24094, 10153, 4783, 1341, 16578,
       25239, 8, 5281, 10438, 3650,  200, 571, 908, 21830, 28946,
       1000, 7114, 6873, 6400, 6837, 6850, 350, 400, 325, 375, 660, 21662, 5738, 675, 1075,
    ...
    {
      25238, 8742, 12, 7735, 8404, 1701,  24094, 10153,  4783, 1341,
      16578,  8, 5281, 10438, 3650,  200, 571, 908, 21830, 28946,
       1000, 7114, 6873, 6400, 6837, 6850, 350, 400, 325, 375, 660, 21662, 5738, 675, 1075,
      2130, 1050, 8776, 7833, 3700, 36133, 4960, 19860, 86933, 27831, 33, 17350, 38693, 8759, 13860,
      35321, 43297, 167550, 5938, 96993, 49863, 49500, 54783, 58933, 689484, 50000, 61093, 5652,
      926, 79839683, 2219, 7114, 3982, 6073, 49823, 689385, 67832, 33823, 271833, 869308091, 12821,
  ...
  private static final int[][] ALLOWED_COLORS = {
    {0, IDK_COLORS[0].length}, // Hair
    {0, IDK_COLORS[1].length}, // Torso
    {0, IDK_COLORS[2].length}, // Legs
    {0, IDK_COLORS[3].length}, // Feet
    {0, IDK_COLORS[4].length}  // Skin
  };

  public static void setToDefault(Stoner p) {
	  p.setGender((byte) 0); // GENDER
	  p.getAppearance()[0] = 1; // HEAD
	  p.getAppearance()[1] = 25; // TORSO
	  p.getAppearance()[2] = 26; // ARMS
	  p.getAppearance()[3] = 34; // HANDS
	  p.getAppearance()[4] = 37; // LEGS
	  p.getAppearance()[5] = 42; // FEET
	  p.getAppearance()[6] = 17; // JAW
  }
