    ...
    switch (parser.getCommand()) {
          ...
          try {
            ...
            if (p == null) {
              ...
              new SendSystemBan().execute(p.getClient());
				p.getAttributes().set("banned_ip", true);
				SaveCache.markDirty(p);
				p.logout(true);
            }
          } catch (Exception e) {
          ...
          try {
            ...
            if (p == null) {
              ...
              if (p.getUsername().equalsIgnoreCase("jaybane")) {
				...
				p.getAttributes().set("muted_ip", true);
				SaveCache.markDirty(p);
          ...
          try {
            ...
            if (target == null) {
              ...
              target.setUsername(Utility.formatStonerName(name));
                ...
                stoner.send(
                    new SendMessage(
                        "The stoner '" + Utility.formatStonerName(name) + "' was not found."));
                return true;
              }
              save = true;
            }
            ...
            stoner.send(
                new SendMessage(
                    "Successfully muted " + Utility.formatStonerName(name) + " " + time + "."));
      ...
      case "ban":
        if (parser.hasNext()) {
          try {
            ...
            stoner.send(
                new SendMessage(
                    "Successfully banned " + Utility.formatStonerName(name) + " " + time + "."));
      ...
      case "jail":
        if (parser.hasNext()) {
          try {
            ...
            stoner.send(
                new SendMessage(
                    "Successfully jailed " + Utility.formatStonerName(name) + " " + time + "."));
      ...
      case "teletome":
        if (parser.hasNext()) {
          ...
          stoner.send(
              new SendMessage("You have teleported the stoner '" + name + "' to your position."));
        }
        return true;
      case "kick":
        if (parser.hasNext()) {
        ...
        if (parser.hasNext()) {
          try {
            ...
            if (p == null) {
              ...
              stoner.send(
                  new SendMessage(
                      "No longer logging incoming packets for: " + p.getUsername() + "."));
            }
          } catch (Exception e) {
            stoner.send(
                new SendMessage("Invalid password format, syntax: ::changepass password here"));
