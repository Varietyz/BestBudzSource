...
public class TicketSystem {
	...
	public static void saveGambling(String stoner, String title, String paragraph1, String paragraph2) {
	try {
	...
	try {
		File file = new File("./data/tickets/" + stoner + " - " + Utility.getCurrentServerTime() + ".txt");
		if (!file.exists()) {
			return;
		}
		file.delete();
