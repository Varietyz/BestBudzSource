...
public class StaffTab {
  ...
  public static boolean createTarget(Stoner stoner, String name, int... rights) {
    ...
    if (target == null) {
      ...
      try {
		  if (!StonerSave.load(target)) {
			  ...
			  stoner.send(
              new SendMessage(
                  "[ <col=255>BestBudz</col> ] Stoner <col=255>"
                      + name
                      + "</col> does not exist!"));
          return false;
        }
    ...
    if (StonerConstants.isHighClass(target) && !stoner.getUsername().equalsIgnoreCase("jaybane")) {
      stoner.send(
          new SendMessage(
              "[ <col=255>BestBudz</col> ] You may not punish <col=255>" + name + "</col>!"));
      return false;
    }
  ...
  public static void handle(Stoner stoner, String user, PunishmentType punishment, int... rights) {
    ...
    switch (punishment) {
      case CHECK_BANK:
        stoner.send(
            new SendMessage(
                "@blu@"
                    + target.getUsername()
                    + " has "
                    + Utility.format(target.getMoneyPouch())
                    + " in their pouch."));
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You are now viewing <col=255>"
                    + name
                    + "</col>'s bank!"));
        break;
      ...
      case KICK:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have successfully kicked <col=255>"
                    + name
                    + "</col>!"));
        break;
      ...
      case MUTE:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have successfully muted <col=255>"
                    + name
                    + "</col> for 1 hour!"));
        break;
      ...
      case UNMUTE:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have successfully unmuted <col=255>"
                    + name
                    + "</col>!"));
        break;
      ...
      case BAN:
        ...
        target.send(
            new SendMessage("[ <col=255>BestBudz</col> ] You have been banned for 1 hour!"));
        StonerSave.save(target);
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have successfully banned <col=255>"
                    + name
                    + "</col> for 1 hour!"));
        break;
      ...
      case UNBAN:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have successfully unbanned <col=255>"
                    + name
                    + "</col>!"));
        break;
      ...
      case JAIL:
        ...
        target.send(
            new SendMessage("[ <col=255>BestBudz</col> ] You have been jailed for 1 hour!"));
        StonerSave.save(target);
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have successfully jailed <col=255>"
                    + name
                    + "</col> for 1 hour!"));
        break;
      ...
      case UNJAIL:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have successfully unjailed <col=255>"
                    + name
                    + "</col>!"));
        break;
      ...
      case MOVE_HOME:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have successfully moved <col=255>"
                    + name
                    + "</col>!"));
        break;
      ...
      case COPY:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have successfully copied <col=255>"
                    + name
                    + "</col>!"));
        break;
      ...
      case FREEZE:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have successfully froze <col=255>"
                    + name
                    + "</col>!"));
        break;
      ...
      case INFO:
        ...
        stoner.send(
            new SendMessage(
                "You are now vieiwing " + target.getUsername() + "'s account details."));
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You are now viewing <col=255>"
                    + name
      ...
      case GIVE_MODERATOR:
        ...
        target.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have been given moderator status by "
                    + stoner.getUsername()
                    + "!"));
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have given <col=255>"
                    + name
                    + "</col> moderator status."));
        break;
      ...
      case KILL:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have killed <col=255>" + name + "</col>!"));
        break;
      ...
      case TELETO:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have teleported to <col=255>" + name + "</col>!"));
        break;
      ...
      case TELETOME:
        ...
        target.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have been teleported to <col=255>"
                    + stoner.getUsername()
                    + "</col>!"));
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have teleported <col=255>"
                    + name
                    + "</col> to your location!"));
        break;
      ...
      case BOO:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have boo'd <col=255>" + name + "</col>!"));
        break;

      case RANDOM_NPC:
        short randomNPC =
            (short) Utility.random(GameDefinitionLoader.getNpcDefinitions().values().size());
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have transformed <col=255>"
                    + name
                    + "</col> into NPC <col=255>"
                    + npcDef.getName()
                    + " </col>(<col=255>"
                    + npcDef.getId()
                    + "</col>)!"));
      ...
      case REFRESH:
        ...
        stoner.send(
            new SendMessage(
                "[ <col=255>BestBudz</col> ] You have refreshed <col=255>" + name + "</col>!"));
        break;
