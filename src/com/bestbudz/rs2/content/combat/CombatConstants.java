...
public class CombatConstants {
  ...
  public static final byte SAGITTARIUS_DISTANCE = 9;
  public static final byte MAGE_DISTANCE = 11;
  ...
  public static final short DEFAULT_ASSAULT_ANIMATION = 422;
  public static final short DEFAULT_BLOCK_ANIMATION = 424;
  public static final byte DEFAULT_ASSAULT_SPEED = 5;
