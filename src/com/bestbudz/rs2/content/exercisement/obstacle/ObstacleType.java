...
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.ClimbInteraction;
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.ClimbOverInteraction;
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.ObstacleInteraction;
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.RopeSwingInteraction;
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.SteppingStonesInteraction;
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.WalkInteraction;
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.rooftop.ardougne.ArdougneJumpGapInteraction;
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.rooftop.ardougne.ArdougneRoofJumpInteraction;
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.rooftop.ardougne.ArdougneRoofJumpInteraction2;
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.rooftop.ardougne.ArdougneWallClimbInteraction;
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.rooftop.seers.SeersJumpGapInteraction;
import com.bestbudz.rs2.content.exercisement.obstacle.interaction.rooftop.seers.SeersJumpGapInteraction2;
...
public enum ObstacleType {
	...
	LEDGE(new WalkInteraction() {
		...
		@Override
		public String getPostMessage() {
		return "You professionfully ege across the gap.";
		}
	}),
	...
	ROPE_SWING(new RopeSwingInteraction() {
		...
		@Override
		public String getPreMessage() {
		return "You professionfully swing across.";
		}
	...
	// GRAPPLE(Arrays.asList(7081), "You hook the grapple onto the ledge...",
	// "...you jump safely down the other side."),
	...
	public void execute(Stoner stoner, Obstacle next, Location start, Location end, int ordinal) {
	interaction.execute(stoner, next, start, end, ordinal);
	}
}