...
public class BoneBurying {
	...
	stoner.getClient().queueOutgoingPacket(new SendMessage("" + Item.getDefinition(bones.id).getName() + " have been fed to your pet fish."));
	...
	stoner.getClient().queueOutgoingPacket(new SendMessage("You sacrifice the " + Item.getDefinition(bones.id).getName() + " at the altar."));
