...
public class NecromanceBook {
	...
	private static final Necromance[] OVER_HEAD_DISABLED = new Necromance[] { Necromance.PROTECT_FROM_MAGE, Necromance.PROTECT_FROM_RANGE, Necromance.PROTECT_FROM_MELEE, Necromance.RETRIBUTION, Necromance.REDEMPTION, Necromance.SMITE };
	private static final Necromance[] AEGIS_DISABLED = new Necromance[] { Necromance.THICK_SKIN, Necromance.ROCK_SKIN, Necromance.STEEL_SKIN, Necromance.CHIVALRY, Necromance.PIETY };
	private static final Necromance[] ASSAULT_DISABLED = new Necromance[] { Necromance.CLARITY_OF_THOUGHT, Necromance.IMPROVED_REFLEXES, Necromance.INCREDIBLE_REFLEXES, Necromance.SHARP_EYE, Necromance.HAWK_EYE, Necromance.EAGLE_EYE, Necromance.MYSTIC_WILL, Necromance.MYSTIC_LORE, Necromance.MYSTIC_MIGHT, Necromance.CHIVALRY, Necromance.PIETY };
	private static final Necromance[] VIGOUR_DISABLED = new Necromance[] { Necromance.BURST_OF_VIGOUR, Necromance.SUPERHUMAN_VIGOUR, Necromance.ULTIMATE_VIGOUR, Necromance.SHARP_EYE, Necromance.HAWK_EYE, Necromance.EAGLE_EYE, Necromance.MYSTIC_WILL, Necromance.MYSTIC_LORE, Necromance.MYSTIC_MIGHT, Necromance.CHIVALRY, Necromance.PIETY };
	private static final Necromance[] ATT_STR_DISABLED = new Necromance[] { Necromance.CLARITY_OF_THOUGHT, Necromance.IMPROVED_REFLEXES, Necromance.INCREDIBLE_REFLEXES, Necromance.BURST_OF_VIGOUR, Necromance.SUPERHUMAN_VIGOUR, Necromance.ULTIMATE_VIGOUR, Necromance.SHARP_EYE, Necromance.HAWK_EYE, Necromance.EAGLE_EYE, Necromance.MYSTIC_WILL, Necromance.MYSTIC_LORE, Necromance.MYSTIC_MIGHT, Necromance.CHIVALRY, Necromance.PIETY };
	private static final Necromance[] COMBAT_DISABLED = new Necromance[] { Necromance.CLARITY_OF_THOUGHT, Necromance.IMPROVED_REFLEXES, Necromance.INCREDIBLE_REFLEXES, Necromance.BURST_OF_VIGOUR, Necromance.SUPERHUMAN_VIGOUR, Necromance.ULTIMATE_VIGOUR, Necromance.THICK_SKIN, Necromance.ROCK_SKIN, Necromance.STEEL_SKIN, Necromance.SHARP_EYE, Necromance.HAWK_EYE, Necromance.EAGLE_EYE, Necromance.MYSTIC_WILL, Necromance.MYSTIC_LORE, Necromance.MYSTIC_MIGHT, Necromance.CHIVALRY, Necromance.PIETY };
	...
	public enum Necromance {
		...
		private Necromance(String name, int grade, double drainRate, int configId, NecromanceType type) {
		this.name = name;
		this.grade = grade;
	...
	if (stoner.getMaxGrades()[5] < necromance.getGrade()) {
		stoner.send(new SendMessage("You need a Necromance grade of " + necromance.getGrade() + " to use " + necromance.getName() + "."));
		return false;
	...
	if (stoner.isDead()) {
		...
		stoner.send(new SendMessage("Necromance powers are exhausted; you could recharge these from your info-tab."));
	...
	case 19137:
		for (Necromance necromance : Necromance.values()) {
			stoner.send(new SendConfig(630 + necromance.ordinal(), quickNecromances[necromance.ordinal()] ? 1 : 0));
		}
	...
	return necromance.getDrainRate() * (1 + 0.035 * stoner.getBonuses()[EquipmentConstants.NECROMANCE]);
	}
	...
	int necromance = stoner.getProfession().getGrades()[5];
	if (drain >= necromance) {
		...
		stoner.getClient().queueOutgoingPacket(new SendMessage("You have run out of necromance points; you must recharge at an altar."));
	} else {
