...
public enum HideTanData {
  ...
  private static final Map<Short, HideTanData> hideRewards = new HashMap<Short, HideTanData>();
  private final short itemId;
  private final int[] bestbucks;
  private final short outcome;
  private final short requiredGrade;
  private final int[] craftableOutcomes;

  HideTanData(
      int itemId, int[] bestbucks, int outcome, int requiredGrade, int[] craftableOutcomes) {
  ...
  public static final void declare() {
    for (HideTanData hide : values()) hideRewards.put(Short.valueOf(hide.getOutcome()), hide);
  }
