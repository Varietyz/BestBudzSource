...
public class ArmourCreation extends ProductionTask {
  ...
  public String getSuccessfulProductionMessage() {
    ...
    if ((itemName.contains("glove"))
        || (itemName.contains("boot"))
        || (itemName.contains("vamb"))
        || (itemName.contains("chap"))) prefix = "a pair of";
    else if (itemName.endsWith("s")) prefix = "some";
  ...
  public String noIngredients(Item item) {
    return "You don't have enough "
        + GameDefinitionLoader.getItemDef(item.getId()).getName()
        + " to craft this item.";
  }
