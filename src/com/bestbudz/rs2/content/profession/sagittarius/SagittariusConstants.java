...
public class SagittariusConstants {
  ...
  public static Graphic getDrawbackGraphic(Stoner stoner) {
    ...
    switch (weapon.getSagittariusDefinition().getType()) {
      case SHOT:
        switch (weapon.getId()) {
          case 4214:
  ...
  public static Projectile getProjectile(Stoner stoner) {
    Item weapon = stoner.getEquipment().getItems()[3];
    Item ammo = stoner.getEquipment().getItems()[13];
    if (weapon == null || weapon.getSagittariusDefinition() == null) {
      return null;
      ...
      case SHOT:
        switch (weapon.getId()) {
          ...
          case 12926:
            ...
            switch (stoner.getToxicBlowpipe().getBlowpipeAmmo().getId()) {
              case 11231:
