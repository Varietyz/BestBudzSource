...
public class Pyromaniac {
	...
	public static enum Wood {
		...
		int stunTime;
		private static Map<Integer, Wood> wood = new HashMap<Integer, Wood>();
		...
		private Wood(int id, double experience, int time) {
		this.id = id;
    ...
    stoner.freeze(5, 5);
	stoner.setCurrentStunDelay(System.currentTimeMillis() + wood.getStunTime() * 1000);
