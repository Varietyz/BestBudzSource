...
public class BoltEnchanting {
	...
	private static final int[] grades = { 4, 7, 14, 24, 27, 29, 49, 57, 68, 87 };
	private static final int[][] runes = { { 564, 1 }, { 556, 2 }, { 564, 1 }, { 555, 1 }, { 558, 1 }, { 564, 1 }, { 557, 2 }, { 564, 1 }, { 555, 2 }, { 564, 1 }, { 556, 3 }, { 561, 1 }, { 564, 1 }, { 554, 2 }, { 564, 1 }, { 554, 5 }, { 565, 1 }, { 564, 1 }, { 557, 10 }, { 563, 2 }, { 564, 1 }, { 557, 15 }, { 566, 1 }, { 564, 1 }, { 554, 20 }, { 560, 1 } };
	private static final Item[] item = { new Item(9236), new Item(9240), new Item(9237), new Item(9238), new Item(9241), new Item(9239), new Item(9242), new Item(9243), new Item(9244), new Item(9245) };
	...
	public enum BoltData {
		...
		BoltData(int bolt, int enchantedBolt, int gradeRequired, Item... runesRequired) {
		this.bolt = bolt;
