      ...
      switch (usedWith.getId()) {
        ...
        case 12934:
          if (stoner
              .getBox()
              .hasAllItems(
                  new Item(554, 5), new Item(560, 1), new Item(562, 1), new Item(12934, 1))) {
            ...
            for (Item item : stoner.getBox().getItems()) {
              if (item != null) {
                switch (item.getId()) {
                  ...
                  case 562:
                  case 12934:
                    if (item.getAmount() / (item.getId() == 12934 ? 1 : item.getId() == 554 ? 5 : 1)
                        < min) {
                      min =
                          item.getAmount()
                              / (item.getId() == 12934 ? 1 : item.getId() == 554 ? 5 : 1);
                    }
                    break;
                }
              }
