...
public class MageConstants {
  ...
  public static final Item[] VENGEANCE_RUNES = {
    new Item(9075, 4), new Item(557, 10), new Item(560, 2)
  };
  ...
  public static void declare() {
    for (int i = 0; i < 150000; i++) {
      ...
      if (def != null) {
        ...
        if (n.contains("fire")) spellTypes.put(Integer.valueOf(def.getId()), SpellType.FIRE);
        else if (n.contains("earth")) spellTypes.put(Integer.valueOf(def.getId()), SpellType.EARTH);
        else if ((n.contains("air")) || (n.contains("wind")))
          spellTypes.put(Integer.valueOf(def.getId()), SpellType.WIND);
        else if (n.contains("water")) spellTypes.put(Integer.valueOf(def.getId()), SpellType.WATER);
      }
    }
  }
  ...
  public static MageProfession.SpellBookTypes getStaffType(int id) {
    switch (id) {
      case 4675:
        return MageProfession.SpellBookTypes.ANCIENT;
    }
    return MageProfession.SpellBookTypes.MODERN;
  }

  public static String spellTypeToString(MageProfession.SpellBookTypes spellBookType) {
