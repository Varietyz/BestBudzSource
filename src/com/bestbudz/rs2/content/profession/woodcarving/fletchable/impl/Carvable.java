...
public enum Carvable implements Fletchable {
	LOG(new Item(946), new Item(1511), new FletchableItem(new Item(53, 5), 1, 5.0), new FletchableItem(new Item(50), 1, 5.0), new FletchableItem(new Item(48), 1, 10.0), new FletchableItem(new Item(9440), 1, 6.0)),
	OAK_LOG(new Item(946), new Item(1521), new FletchableItem(new Item(54), 1, 16.5), new FletchableItem(new Item(56), 1, 25.0), new FletchableItem(new Item(9442), 1, 16.0)),
	WILLOW_LOG(new Item(946), new Item(1519), new FletchableItem(new Item(60), 1, 33.3), new FletchableItem(new Item(58), 1, 41.5), new FletchableItem(new Item(9444), 1, 22.0)),
	TEAK_LOG(new Item(946), new Item(6333), new FletchableItem(new Item(9446), 1, 27.0)),
	MAPLE_LOG(new Item(946), new Item(1517), new FletchableItem(new Item(64), 1, 50.0), new FletchableItem(new Item(62), 1, 51.3), new FletchableItem(new Item(9448), 1, 32.0)),
	MAHOGANY_LOG(new Item(946), new Item(6332), new FletchableItem(new Item(9450), 1, 41.0)),
	YEW_LOG(new Item(946), new Item(1515), new FletchableItem(new Item(68), 1, 67.5), new FletchableItem(new Item(66), 1, 75.0), new FletchableItem(new Item(9452), 1, 50.0)),
	MAGE_LOG(new Item(946), new Item(1513), new FletchableItem(new Item(72), 1, 83.3), new FletchableItem(new Item(70), 1, 91.5)),
	...
	DRAGONSTONE_BOLT_TIP(new Item(1755), new Item(1615), new FletchableItem(new Item(9193, 12), 1, 8.2)),
