...
public enum Arrow implements Fletchable {
	...
	MITHRIL_ARROWS(new Item(53, 15), new Item(42, 15), new FletchableItem(new Item(888, 15), 1, 112.5)),
	ADAMANT_ARROWS(new Item(53, 15), new Item(43, 15), new FletchableItem(new Item(890, 15), 1, 150.0)),
	RUNE_ARROWS(new Item(53, 15), new Item(44, 15), new FletchableItem(new Item(892, 15), 1, 187.5)),
	DRAGON_ARROWS(new Item(53, 15), new Item(11237, 15), new FletchableItem(new Item(11212, 15), 1, 225.0));
