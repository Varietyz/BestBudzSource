...
public class Professions {
	...
	public static final int GRADE_99_SONG = 99;
	public static final int[] GRADE_UP_SOUNDS = { 112, 107, 104, 10, 21, 24 };
	public static final int PROFESSION_COUNT = 25;
	...
	public static final String[] PROFESSION_NAMES = { "assault", "aegis", "vigour", "life", "sagittarius", "necromance", "mage", "foodie", "lumbering", "woodcarving", "fisher", "pyromaniac", "handiness", "forging", "quarrying", "thc-hempistry", "weedsmoking", "accomplisher", "mercenary", "cultivation", "consumer", "summoning", "hunter", "construction", "dungeoneering" };
	...
	public static final boolean isSuccess(int profession, int gradeRequired) {
	...
	public static final boolean isSuccess(Stoner p, int professionId, int gradeRequired, int toolGradeRequired) {
