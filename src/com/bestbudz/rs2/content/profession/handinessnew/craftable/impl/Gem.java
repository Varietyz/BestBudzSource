...
public enum Gem implements Craftable {
  ...
  RED_TOPAZ(
      new Item(1755), new Item(1629), new CraftableItem(new Item(1613), new Item(1629), 16, 25.0)),
  SAPPHIRE(
      new Item(1755), new Item(1623), new CraftableItem(new Item(1607), new Item(1623), 20, 50.0)),
  EMERALD(
      new Item(1755), new Item(1621), new CraftableItem(new Item(1605), new Item(1621), 27, 67.5)),
  RUBY(new Item(1755), new Item(1619), new CraftableItem(new Item(1603), new Item(1619), 34, 85.0)),
  DIAMOND(
      new Item(1755), new Item(1617), new CraftableItem(new Item(1601), new Item(1617), 43, 107.5)),
  DRAGONSTONE(
      new Item(1755), new Item(1631), new CraftableItem(new Item(1615), new Item(1631), 55, 137.5)),
  ONYX(
      new Item(1755), new Item(6571), new CraftableItem(new Item(6573), new Item(6571), 67, 167.5));
