...
public class PetGrowth
{
	...
	static {
		...
		REQUIREMENTS.put(PetData.TOY_JAD, new GrowthRequirement(15, 10, 30 * 60000));
		REQUIREMENTS.put(PetData.INFANT_JAD, new GrowthRequirement(50, 25, 60 * 60000));
		REQUIREMENTS.put(PetData.HATCHLING_JAD, new GrowthRequirement(90, 45, 2 * 60 * 60000));
		REQUIREMENTS.put(PetData.CUB_JAD, new GrowthRequirement(130, 65, 4 * 60 * 60000));
		REQUIREMENTS.put(PetData.YOUTH_JAD, new GrowthRequirement(180, 85, 8 * 60 * 60000));
		REQUIREMENTS.put(PetData.TEEN_JAD, new GrowthRequirement(230, 105, 12 * 60 * 60000));
		REQUIREMENTS.put(PetData.YOUNG_ADULT_JAD, new GrowthRequirement(290, 130, 24 * 60 * 60000));
		REQUIREMENTS.put(PetData.ADULT_JAD, new GrowthRequirement(350, 160, 48 * 60 * 60000));
		REQUIREMENTS.put(PetData.PRIME_JAD, new GrowthRequirement(420, 195, 72 * 60 * 60000));
