...
public enum UntrimmedWeedData {
  ...
  private static final Map<Integer, UntrimmedWeedData> weeds =
      new HashMap<Integer, UntrimmedWeedData>();
  private final int untrimmedWeed;
  private final int cleanWeed;
  private final int gradeReq;
  private final int cleaningExp;

  UntrimmedWeedData(int untrimmedWeed, int cleanWeed, int gradeReq, int cleaningExp) {
