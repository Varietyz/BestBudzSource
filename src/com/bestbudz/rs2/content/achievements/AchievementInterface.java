...
public class AchievementInterface {
	...
	DialogueManager.sendInformationBox(stoner, "<u>Achievement System", "@dre@" + achievement.getName(), "@bla@Difficulty: @blu@" + difficulty, "@bla@Point(s): @blu@" + achievement.getReward(), "Progress: @blu@" + completed + "@bla@/@blu@" + achievement.getCompleteAmount() + " @bla@(@blu@" + progress + "%@bla@)");
	}
