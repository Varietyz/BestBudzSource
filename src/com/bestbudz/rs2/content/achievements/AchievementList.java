...
public enum AchievementList {
	...
	VIEW_15_STONER_PROFILES("View 15 stoners on Bongbase", 15, AchievementDifficulty.EASY),
	...
	// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.EASY),
	// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.EASY),
	// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.EASY),
	// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.EASY),
	// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.EASY),
	...
	// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.MEDIUM),
	// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.MEDIUM),
	// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.MEDIUM),
	// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.MEDIUM),
	// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.MEDIUM),
	...
	SMOKE_10000G_WEED("Smoke 10KG of weed", 10000, AchievementDifficulty.HARD);
		// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.HARD),;
		// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.HARD),;
		// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.HARD),;
		// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.HARD),;
		// ENUM_NAME("Achievement text get 50", 50, AchievementDifficulty.HARD),;
