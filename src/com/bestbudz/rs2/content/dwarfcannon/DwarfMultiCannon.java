...
public class DwarfMultiCannon {
  ...
  public static final boolean isCannonSetupClear(Stoner stoner) {
    ...
    return Region.getRegion(x2, y2).canMove(x2, y2, z, 3);
  }
  ...
  public static final boolean setCannonBase(Stoner stoner, int id) {
    if (id == 6) {
      if (isCannonSetupClear(stoner)) {
              ...
              public void onDestination() {
                if (stoner.getBox().hasItemId(6)) {
                  ...
                  stoner
                      ...
                      .set(
                          "dwarfmulticannon",
                          new DwarfCannon(stoner, l.getX(), l.getY(), l.getZ()));
                }
              }
            });
      } else {
        stoner
            .getClient()
            .queueOutgoingPacket(new SendMessage("You cannot setup your cannon here."));
      }
