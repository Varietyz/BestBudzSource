...
public class MysteryBox {
	/**
	 * Misery Box Identification
	 */
	private final static Item MYSTERY_BOX = new Item(6199);

	/**
	 * All possible loots from Misery Box
	 */
	public static Chance<Item> LOOTS = new Chance<Item>(Arrays.asList(
			...
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(1725, 1)), // Amulet of vigour
			...
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(158, 5)), // Super vigour(3)
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2441, 5)), // Super vigour(4)
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2437, 5)), // Super assault(4)
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2443, 5)), // Super aegis(4)
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(166, 5)), // Super aegis(2)
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(3027, 5)), // Steroid v2(3)
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(3025, 5)), // Steroid v2(4)
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(13066, 1)), // Super potion set
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(6688, 5)), // Healing ale of the gods(3)
			...
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(12932, 1)), // Mage fang
	...
	/**
	 * Handles opening the Misery Box
	 * 
	 * @param stoner
	 */
	...
	stoner.send(new SendMessage("You have opened the and were rewarded with " + formatted_name + " ."));
	if (reward.getDefinition().getGeneralPrice() >= 1_500_000) {
		World.sendGlobalMessage("@mbl@" + stoner.deterquarryIcon(stoner) + " " + stoner.getUsername() + " has recieved " + formatted_name + " from a Misery Box!");
	}
	}
