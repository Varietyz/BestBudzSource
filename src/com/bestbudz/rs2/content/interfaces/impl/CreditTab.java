...
public class CreditTab extends InterfaceHandler {
	...
	private final String[] text = { "Open CannaCredits shops", "Inf. Special Assault (@gre@1M</col>)", "@gre@Tap Tycoon</col>", "Open Bank (@yel@30</col>)", "Unlock Free Teleports (@gre@350</col>)", "Unlock Disease Immunity (@gre@270</col>)", "Remove Teleblock (@cya@200</col>)", "Expensive Easy Shop (@gre@SOON</col>)", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
