				 ...
				 "@bla@_____________________",
				  ...
				  "@whi@Username: @yel@" + Utility.capitalizeFirstLetter(stoner.getUsername()),
				   ...
				   "@whi@Rank: @gre@" + stoner.deterquarryIcon(stoner) + stoner.deterquarryRank(stoner),
					...
					"@whi@Contributed: @yel@$" + Utility.format(stoner.getMoneySpent()),
		
					"@whi@[ </col>@yel@Check @whi@] My Points",//0
		
					"@whi@[ </col>@yel@Check @whi@] Tracked PvM Kills",//0
					 ...
					 "@bla@_____________________",
						...
						"@whi@[ </col>@cya@CHANGE @whi@] Type of Mage",//0
		
							  "@whi@[ </col>@cya@OPEN @whi@] Drop Table",//0
		
							"@whi@[ </col>@cya@ADVANCE @whi@] Professions",//0
		
						"@whi@[ </col>@gre@CHECK @whi@] Stoner shops",//0
