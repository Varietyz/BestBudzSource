...
public class StonerProfiler {
    ...
    TaskQueue.queue(
        new Task(2) {
          ...
          public void execute() {
            ...
            int deltaX =
                viewing.getLocation().getX() - (stoner.getCurrentRegion().getRegionX() << 3);
            int deltaY =
                viewing.getLocation().getY() - (stoner.getCurrentRegion().getRegionY() << 3);
  ...
  public static void displayProfile(Stoner stoner, Stoner viewing) {
    ...
    stoner.send(
        new SendString(
            "</col>Name: @gre@" + Utility.capitalizeFirstLetter(viewing.getUsername()), 51807));
    stoner.send(
        new SendString(
            "</col>Rank: @gre@"
    ...
    stoner.send(
        new SendString(
            ...
            51889));
    stoner.send(
        new SendString("</col>Mercenary Points: @whi@" + viewing.getMercenaryPoints(), 51890));
  ...
  public static void myProfile(Stoner stoner) {
    ...
    stoner.send(
        new SendString(
            "</col>Name: @gre@" + Utility.capitalizeFirstLetter(stoner.getUsername()), 51607));
    stoner.send(
        new SendString(
            "</col>Rank: @gre@"
    ...
    stoner.send(
        new SendString(
            ...
            51690));
    stoner.send(
        new SendString("</col>Mercenary Points: @whi@" + stoner.getMercenaryPoints(), 51691));
