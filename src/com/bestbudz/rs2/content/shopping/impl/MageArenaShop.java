...
public class MageArenaShop extends Shop {
	...
	super(SHOP_ID, new Item[] { new Item(6918), new Item(6916), new Item(6924), new Item(6922), new Item(6920), new Item(6908), new Item(6910), new Item(6912), new Item(6914), new Item(12528), new Item(12530), new Item(6889), new Item(8015), new Item(560), new Item(565), }, false, "Mage Arena Store");
	}
	...
	if (stoner.getArenaPoints() < amount * getPrice(id)) {
		stoner.getClient().queueOutgoingPacket(new SendMessage("You do not have enough Mage Arena points to buy that."));
		return;
	}

	stoner.setArenaPoints(stoner.getArenaPoints() - (amount * getPrice(id)));
