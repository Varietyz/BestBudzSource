...
public class AdvanceShop extends Shop {
	 ...
	 */
	public AdvanceShop() {
	super(SHOP_ID, new Item[] { new Item(1419), new Item(6656), new Item(6654), new Item(6655), new Item(11919), new Item(12956), new Item(12957), new Item(12958), new Item(12959), new Item(9472), new Item(6182), new Item(6180), new Item(6181), new Item(12887), new Item(12888), new Item(12889), new Item(12890), new Item(12891), new Item(12892), new Item(12893), new Item(12894), new Item(12895), new Item(12896), new Item(3057), new Item(11282), new Item(11280), new Item(2631), new Item(7594), new Item(7592), new Item(7593), new Item(7595), new Item(7596),
	...
	if (stoner.getAdvancePoints() < amount * getPrice(id)) {
		stoner.getClient().queueOutgoingPacket(new SendMessage("You do not have enough Advance points to buy that."));
		return;
	}
