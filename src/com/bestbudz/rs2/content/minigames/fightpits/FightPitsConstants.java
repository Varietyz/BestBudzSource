...
public class FightPitsConstants {
  ...
  public static final String NOT_ENOUGH_STONERS_MESSAGE =
      "There are not enough stoners to start Fight Pits!";
  ...
  public static final String INTO_ARENA_FAILURE_MESSAGE =
      "You will be teleported in when the game starts.";
