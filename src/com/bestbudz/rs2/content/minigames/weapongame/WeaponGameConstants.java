...
public class WeaponGameConstants {
	...
	/**
	 * Minimum amount of stoners required to start a game
	 */
	public static final int MINIMUM_STONERS = 5;

	/**
	 * The maximum amount of stoners that can participate in the game
	 */
	public static final int MAXIMUM_STONERS = 20;

	/**
	 * The combat grade required to play this game
	 */
	 ...
	 */
	public static Item[][] TIER_DATA = { { new Item(1217) }, // TIER 1
