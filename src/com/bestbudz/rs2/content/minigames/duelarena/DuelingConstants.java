...
public class DuelingConstants {
  ...
  public static final int DUEL_VICTORY_COMBAT_GRADE_ID = 6839;
  ...
  public static final Location[] RESPAWN_LOCATIONS = {
    new Location(3363, 3276),
    new Location(3369, 3275),
    new Location(3373, 3275),
    new Location(3377, 3275),
    new Location(3377, 3275),
    new Location(3370, 3268),
    new Location(3363, 3268)
  };
  public static final int WHIP_AND_DDS_ONLY = 0;
  public static final int NO_MOVEMENT = 1;
  public static final int NO_SAGITTARIUS = 2;
  ...
  public static final int[] DUEL_RULE_IDS = {
    1, 2, 16, 32, 64, 128, 256, 512, 1024, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288,
  ...
  public static final int[] DURING_THE_DUEL_STRING_IDS = {
    8242, 8243, 8244, 8245, 8246, 8247, 8248, 8249, 8251, 8252, 8253
  };
  public static final String[] FUN_WEAPON_NAMES = {
    "flowers", "rubber chicken", "easter carrot", "mouse toy", "scythe"
  };
  ...
  public static final String formatAmount(int amount) {
    if (amount >= 10000000) return "@gre@" + amount / 1000000 + " million @whi@(" + amount + ")";
    if (amount >= 100000) {
  ...
  public static final String[] getDuringDuelStringUpdates(boolean[] rules) {
    ...
    if (rules[2]) {
      strings[index] = "You cannot use Sagittarius assaults.";
      index++;
    }

    if (rules[3]) {
      strings[index] = "You cannot use Melee assaults.";
      index++;
    }

    if (rules[4]) {
      strings[index] = "You cannot use Mage assaults.";
      index++;
    }
    ...
    if (rules[10]) {
      strings[index] = "You cannot use special assaults.";
      index++;
    }
  ...
  public static final String getStakedItemsToString(Item[] staked, int count) {
    ...
    for (int i = 0; i < staked.length; i++) {
      ...
      s =
          s
              + staked[i].getDefinition().getName()
              + " x "
              + formatAmount(staked[i].getAmount())
  ...
  public static final boolean hasFunWeapon(Stoner p) {
