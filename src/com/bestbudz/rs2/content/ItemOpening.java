...
public enum ItemOpening {
	...
	/* Packs */
	EMPTY_VIAL_PACK(11877, new Item(230, 1000)),
	WATER_FILLED_VIAL_PACK(11879, new Item(228, 1000)),
	FEATHER_PACK(11881, new Item(314, 1000)),
	BAIT_PACK(11883, new Item(313, 1000)),
	SOFT_CLAY_PACK(12009, new Item(1762, 1000)),
	BROAD_ARROWHEAD_PACK(11885, new Item(11874, 1000)),
	AIR_RUNE_PACK(12728, new Item(556, 1000)),
	WATER_RUNE_PACK(12730, new Item(555, 1000)),
	EARTH_RUNE_PACK(12732, new Item(557, 1000)),
	FIRE_RUNE_PACK(12734, new Item(554, 1000)),
	MIND_RUNE_PACK(12736, new Item(558, 1000)),
	CHAOS_RUNE_PACK(12738, new Item(562, 1000)),
	BIRD_SNARE_PACK(12740, new Item(10007, 1000)),
	BOX_SNARE_PACK(12742, new Item(10009, 1000)),
	MAGE_BOX_PACK(12744, new Item(10025, 10)),
	EYE_OF_NEW_PACK(12859, new Item(222, 1000)),
	...
	/* Mage Box */
	MAGE_BOX(10025, new Item(554, 10000), new Item(555, 10000), new Item(556, 10000), new Item(557, 10000), new Item(558, 10000), new Item(563, 1000), new Item(561, 1000), new Item(562, 1000)),

	/* Weed Box */
	THCHEMPISTRY_BOX(11738, new Item(200, 250), new Item(202, 250), new Item(204, 250), new Item(206, 250), new Item(208, 100), new Item(210, 250), new Item(212, 200), new Item(214, 100), new Item(216, 100), new Item(218, 100), new Item(220, 100));
	 ...
	 * @return
	 */
	public static boolean openSet(Stoner stoner, int item) {
	// Get the item
	...
	// Remove the item set from box
	stoner.getBox().remove(data.itemID);

	// Add all the item pieces to box
	stoner.getBox().addItems(data.items);

	// Send message of successful opening
	stoner.send(new SendMessage("You successfully open the " + GameDefinitionLoader.getItemDef(data.itemID).getName() + "."));
