...
public class OptionDialogue extends Dialogue {
  ...
  public OptionDialogue(
      String option1, Consumer<Stoner> consumer1, String option2, Consumer<Stoner> consumer2) {
  ...
  public OptionDialogue(
      String option1,
      Consumer<Stoner> consumer1,
      String option2,
      Consumer<Stoner> consumer2,
      String option3,
      Consumer<Stoner> consumer3) {
