...
public class DialogueManager {
	...
	public static void sendItem2zoom(Stoner stoner, String text1, String text2, int item1, int item2) {
	stoner.send(new SendString(text1, 6232));
	stoner.send(new SendString(text2, 6233));
	...
	public static void makeItem3(Stoner stoner, int itemId1, String itemName1, int itemId2, String itemName2, int itemId3, String itemName3) {
