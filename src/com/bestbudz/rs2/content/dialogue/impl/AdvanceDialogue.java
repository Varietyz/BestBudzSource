...
public class AdvanceDialogue extends Dialogue {
  ...
  public void execute() {
    switch (next) {
      ...
      case 5:
        DialogueManager.sendNpcChat(
            stoner, 606, Emotion.HAPPY, "The prestiging system is quite simple.");
        next++;
        break;
      case 6:
        DialogueManager.sendNpcChat(
            ...
            606,
            Emotion.HAPPY,
            "When you have reached the grade 99 in any profession",
            "you will have the ability to Advance it.");
        next++;
        break;
      case 7:
        DialogueManager.sendNpcChat(
            ...
            606,
            Emotion.HAPPY,
            "By doing so you will reset your experience to 0.",
            "In return you will be rewarded with bestbucks as well as your",
            "profession being a different color representing the advance grade.");
        setNext(1);
        break;
    }
  }
