...
public class SpiritTree extends Dialogue {
	...
	switch (next) {
	case 0:
		DialogueManager.sendNpcChat(stoner, 3636, e, new String[] { "Where would you like to go?" });
		next += 1;
		break;
	case 1:
		DialogueManager.sendOption(stoner, new String[] { "Gnome Stronghold", "Seers Village" });
	}
	}
}
