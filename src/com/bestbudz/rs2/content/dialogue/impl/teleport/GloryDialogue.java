...
public class GloryDialogue extends Dialogue {
    ...
    switch (id) {
      case 9178:
        ...
        stoner
            ...
            .queueOutgoingPacket(
                new SendMessage(
                    "<col=C60DDE>You use up a charge from your "
      ...
      case 9181:
        ...
        stoner
            .getClient()
            .queueOutgoingPacket(
                new SendMessage("<col=C60DDE>The Wilderness lever is on the wall next to you."));
        stoner.getDialogue().end();
        break;
    }
    return false;
  ...
  @Override
  public void execute() {
    DialogueManager.sendOption(stoner, "Edgeville", "Draynor", "Karamja", "Wilderness Lever");
  }
}
