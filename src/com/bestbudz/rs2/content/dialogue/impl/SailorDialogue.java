      ...
      case DialogueConstants.OPTIONS_5_1:
        if (can()) {
          ...
          DialogueManager.sendNpcChat(
              stoner, 3936, Emotion.ANNOYED, "You do not have " + COST + " bestbucks for this!");
          next = 0;
        }
        break;
    ...
    switch (next) {
      case 0:
        DialogueManager.sendNpcChat(
            ...
            Emotion.HAPPY_TALK,
            "Hello stoner!",
            "Are you interested in traveling the lands of BestBudz?",
            "I can take you places, for " + COST + " bestbucks!");
        next++;
        break;
      case 1:
