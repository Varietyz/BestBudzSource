    ...
    switch (next) {
      case 0:
        DialogueManager.sendNpcChat(
            ...
            Emotion.HAPPY_TALK,
            "Hey there pal!",
            "Welcome to the Weapon Game Lobby.",
      ...
      case 1:
        DialogueManager.sendOption(
            stoner, "How do I play?", "Can I see the rewards store?", "Nothing.");
        break;
      ...
      case 3:
        nChat(
            "Bank all your equipment and box items.",
            "Proceed by entering the portal.",
      ...
      case 4:
        nChat(
            "Once there are a minimum of "
                + WeaponGameConstants.MINIMUM_STONERS
                + " inside the lobby",
            "the game will begin.",
            "The objective is to be the first stoner to reach 10 kills.",
            "Each kill will grant you a new weapon.");
        break;

      case 5:
        nChat(
            "Throughout the game there will be crates that spawn.",
            "Clicking on these crates could",
            "grant you some supplies or gear.",
            "However, there is a chance of something else happening...");
        break;

      case 6:
        nChat(
            "Once the game is over by a stoner winning",
            "All participants will recieve 25,000 points.");
        break;

      case 7:
        nChat(
            "The winning stoner will recieve",
            "35,000 points along with 500k.",
            "Points earned can be used in my store.");
        break;
