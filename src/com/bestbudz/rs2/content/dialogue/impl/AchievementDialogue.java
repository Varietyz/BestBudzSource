...
public class AchievementDialogue extends Dialogue {
	...
	switch (next) {
	case 0:
		DialogueManager.sendNpcChat(stoner, 5527, Emotion.HAPPY, "Hello " + stoner.getUsername() + ".", "How may I help you?");
		next++;
		break;
	case 1:
		...
		break;
	case 2:
		DialogueManager.sendNpcChat(stoner, 5527, Emotion.HAPPY, "I'm looking for the very best of course!");
		next++;
		break;
	case 3:
		...
		break;
	case 4:
		DialogueManager.sendNpcChat(stoner, 5527, Emotion.HAPPY, "Yes!", "Stoners that have completed all the achievements,", "will be rewarded with my cape.");
		next++;
		break;
	case 5:
