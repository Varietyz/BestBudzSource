  ...
  public boolean clickButton(int id) {
    switch (id) {
      ...
      case DialogueConstants.OPTIONS_4_3:
        if (!stoner.getMercenary().hasTask()) {
          DialogueManager.sendStatement(stoner, "A mercenary task is required to reset it!");
          end();
        } else if (!stoner.getBox().hasItemAmount(995, 250000)) {
          DialogueManager.sendStatement(
              stoner,
              "@blu@250,000</col> bestbucks is required to do this;",
              "which you do not have!");
          end();
        } else {
          stoner.getMercenary().reset();
          DialogueManager.sendStatement(
              stoner, "You have reset your task for @blu@250,000 </col>bestbucks.");
    ...
    switch (next) {
      case 0:
        DialogueManager.sendNpcChat(
            ...
            Emotion.HAPPY_TALK,
            "Hello stoner!",
            "I am Vannaka, master of mercenary.",
            "How may I assist you today?");
        next++;
        break;
      case 1:
        DialogueManager.sendOption(
            stoner, "Obtain task", "Set co-op mercenary partner", "Reset my task", "Trade");
        break;
      case 2:
      ...
      case 4:
        DialogueManager.sendNpcChat(
            stoner, 403, Emotion.HAPPY, "Please select the grade of difficulty.");
        next++;
        break;
      case 5:
