...
public class Tutorial extends Dialogue {
	...
	case 0:
		DialogueManager.sendNpcChat(stoner, GUIDE, Emotion.HAPPY_TALK, "High @blu@" + stoner.getUsername() + "</col>, you arrived in Best Budz!", "Shall i show you da way?");
		next++;
		break;
	case 1:
		DialogueManager.sendOption(stoner, new String[] { "Ya man.", "No man." });
		option = 1;
		break;
	case 2:
		end();
		...
		break;
	case 3:
		nChat(new String[] { "join us on discord and check out tutorials!", "Developer/artworker = JayBane", "Community Manager/Admin = Rlmach, Admin = Drenth" });
		break;
	case 4:
		end();
		StarterKit.handle(stoner, 202051);
