...
public enum CreditHandler {
  ...
  SPECIAL_ASSAULT(
      ...
      new Handle() {
        ...
        public void handle(Stoner stoner) {
          ...
          stoner.send(
              new SendMessage(
                  "@blu@You have spent 1.000.000 cannacredits; Remaining: "
                      + stoner.getCredits()
                      + "."));
  ...
  OPEN_BANK(
      ...
      new Handle() {
        ...
        public void handle(Stoner stoner) {
          ...
          stoner.send(
              new SendMessage(
                  "@blu@You have spent 30 cannacredits; Remaining: " + stoner.getCredits() + "."));
          spent(stoner, 30);
        }
      }),
  UNLOCK_FREE_TELEPORTS(
      205055,
      350,
      new Handle() {
        @Override
        public void handle(Stoner stoner) {
          ...
          stoner.send(
              new SendMessage(
                  "@blu@You have spent 350 cannacredits; Remaining: " + stoner.getCredits() + "."));
        }
      }),
  UNLOCK_DISEASE_IMUNITY(
      205056,
      270,
      new Handle() {
        @Override
        public void handle(Stoner stoner) {
          ...
          spent(stoner, 270);
          stoner.send(
              new SendMessage("@gre@You no longer have to deal with crops catching disease!"));
          stoner.send(
              new SendMessage(
                  "@blu@You have spent 270 cannacredits; Remaining: " + stoner.getCredits() + "."));
        }
      }),
  REMOVE_TELEBLOCK(
      205057,
      ...
      new Handle() {
        ...
        public void handle(Stoner stoner) {
          ...
          stoner.send(
              new SendMessage(
                  "@blu@You have spent 200 cannacredits; Remaining: " + stoner.getCredits() + "."));
        }
      }),
  EASY_SHOP(
      205058,
  ...
  public static HashMap<Integer, CreditHandler> cannacredits =
      new HashMap<Integer, CreditHandler>();
  ...
  public static void spent(Stoner stoner, int amount) {
    stoner
        ...
        .queueOutgoingPacket(
            new SendString(
                "</col>CannaCredits: @gre@" + Utility.format(stoner.getCredits()), 52504));
