...
public class MysteryBoxMinigame {
	...
	/**
	 * CannaCredits required for playing
	 */
	...
	/**
	 * Check if stoner can play the Misery Box
	 * 
	 * @param stoner
	 * @return
	 */
	...
	/**
	 * Handles playing the Misery Box
	 * 
	 * @param stoner
	 */
	...
	/**
	 * The reward for playing Misery Box
	 * 
	 * @param stoner
	 * @param itemWon
	 */
