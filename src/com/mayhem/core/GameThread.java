...
import com.mayhem.GameDataLoader;
import com.mayhem.Constants;
import com.mayhem.core.network.PipelineFactory;
import com.mayhem.core.task.TaskQueue;
import com.mayhem.core.util.LineCounter;
import com.mayhem.core.util.Stopwatch;
import com.mayhem.core.util.SystemLogger;
import com.mayhem.rs2.content.skill.hunter.Impling;
import com.mayhem.rs2.content.skill.hunter.SuperMemberImplings;
import com.mayhem.rs2.entity.World;
import com.mayhem.rs2.entity.item.impl.GroundItemHandler;
import com.mayhem.rs2.entity.object.ObjectManager;
import com.mayhem.tools.CharacterBackup;
...
public class GameThread extends Thread {
	...
	private static void startup() throws Exception {
		...
		logger.info("Launching FalconExpress..");
		...
		logger.info("Initializing character backups..");
		CharacterBackup.init();
		
		logger.info("Loading Hunting NPCs");
		Impling.appendImpling();
		SuperMemberImplings.appendSuperImpling();
