...
import com.mayhem.core.cache.ByteStreamExt;
...
public final class RSInterface {
	...
	public static void MiniRaidpanel2() {
		...
		RSinterface.childX = new int[last];
		RSinterface.childY = new int[last];
		setBounds(31107, 371, 60, 0, RSinterface);
		setBounds(31108, 409, 60, 1, RSinterface);
		setBounds(31109, 443, 60, 2, RSinterface);
		setBounds(31110, 479, 60, 3, RSinterface);
		setBounds(31116, 32, 62, 4, RSinterface);
		setBounds(31117, 8, 88, 5, RSinterface);
		setBounds(31118, 87, 88, 6, RSinterface);
	}
