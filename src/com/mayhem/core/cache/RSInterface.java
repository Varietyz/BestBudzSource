...
public final class RSInterface {
	...
	public static void MiniRaidpanel() {
		RSInterface RSinterface = addInterface(37119);
		// addText(27120, "What", 0x999999, false, true, 52, 1);
		// addText(27121, "What", 0x33cc00, false, true, 52, 1);
		// addText(27122, "(Need 5 to 25 players)", 0xffcc33, false, true, 52,
		// addText(27123, "Points", 0x33ccff, false, true, 52, 1);
		...
		RSinterface.childX = new int[last];
		RSinterface.childY = new int[last];
		setBounds(37120, 15, 12, 0, RSinterface);
		setBounds(37121, 15, 30, 1, RSinterface);
		setBounds(37122, 15, 48, 2, RSinterface);
		setBounds(37123, 15, 66, 3, RSinterface);
	}
	
	public static void MiniRaidpanel2() {
		RSInterface RSinterface = addInterface(31100);
		...
		RSinterface.childX = new int[last];
		RSinterface.childY = new int[last];
		setBounds(31101, 361, 26, 0, RSinterface);
		setBounds(31102, 396, 26, 1, RSinterface);
		setBounds(31103, 436, 26, 2, RSinterface);
		setBounds(31104, 474, 26, 3, RSinterface);
		setBounds(31105, 3, 21, 4, RSinterface);
		setBounds(31106, 3, 50, 5, RSinterface);
		setBounds(31107, 371, 60, 6, RSinterface);
		setBounds(31108, 409, 60, 7, RSinterface);
		setBounds(31109, 443, 60, 8, RSinterface);
		setBounds(31110, 479, 60, 9, RSinterface);
		setBounds(31116, 32, 62, 15, RSinterface);
		setBounds(31117, 8, 88, 16, RSinterface);
		setBounds(31118, 87, 88, 17, RSinterface);
	}
