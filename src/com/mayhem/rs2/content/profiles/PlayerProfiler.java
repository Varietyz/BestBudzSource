package com.mayhem.rs2.content.profiles;
...
import com.mayhem.rs2.entity.player.net.out.impl.SendPlayerProfilerIndex;
...
public class PlayerProfiler {
	...
	public static void displayProfile(Player player, Player viewing, boolean inRegion) {
		...
		AchievementHandler.activate(player, AchievementList.VIEW_15_PLAYER_PROFILES, 1);
		...
		String[] STRINGS = { 
			...
			"</col>FalconExpress Bucks: @whi@" + viewing.getCredits(),		
	...
	public static void myProfile(Player player) {
		...
		String[] STRINGS = { 
			...
			"</col>FalconExpress Bucks: @whi@" + player.getCredits(),		
