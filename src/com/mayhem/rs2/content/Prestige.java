...
public class Prestige {
	 ...
	 */
	private static final int MAX_PRESTIGES = 100000;
	...
	public enum PrestigeData {
		ATTACK(199088, "Attack", 0, 51010, 300_000),	
		DEFENCE(199094, "Defence", 1, 51012, 300_000),		
		STRENGTH(199091, "Strength", 2, 51011, 300_000),
		HITPOINTS(199109, "Hitpoints", 3, 51017, 300_000),	
		RANGE(199097, "Range", 4, 51013, 300_000),
		PRAYER(199100, "Prayer", 5, 51014, 1_200_000),
		MAGIC(199103, "Magic", 6, 51015, 300_000),		
		COOKING(199139, "Cooking", 7, 51027, 600_000),		
		WOODCUTTING(199145, "Woodcutting", 8, 51029, 600_000),	
		FLETCHING(199124, "Fletching", 9, 51022, 600_000),	
		FISHING(199136, "Fishing", 10, 51026, 600_000),	
		FIREMAKING(199142, "Firemaking", 11, 51028, 600_000),		
		CRAFTING(199121, "Crafting", 12, 51021, 600_000),		
		SMITHING(199133, "Smithing", 13, 51025, 600_000),		
		MINING(199130, "Mining", 14, 51024, 600_000),	
		HERBLORE(199115, "Herblore", 15, 51019, 600_000),		
		AGILITY(199112, "Agility", 16, 51018, 600_000),		
		THIEVING(199118, "Thieving", 17, 51020, 600_000),		
		SLAYER(199127, "Slayer", 18, 51023, 600_000),	
		FARMING(199148, "Farming", 19, 51030, 600_000),	
		RUNECRAFTING(199106, "Runecraft", 20, 51016, 600_000),
		HUNTER(199151, "Hunter", 21, 51031, 600_000);  
	...
	public static boolean prestigeSkill(Player player, int skillId) {
		...
		AchievementHandler.activate(player, AchievementList.PRESTIGE_5_TIMES, 1);
