package com.mayhem.rs2.content.skill.magic;
...
public final class SpellBookTeleporting {
	...
	enum TeleportationData {
		...
		HOME_TELEPORT(1645, 3674, 75010, 1, new int[] { AIR_RUNE, 3, FIRE_RUNE, 1, LAW_RUNE, 1 }),
		...
		HOME_TELEPORT_ANCIENT(1645, 3674, 84237, 1, new int[] { AIR_RUNE, 3, FIRE_RUNE, 1, LAW_RUNE, 1 }),
