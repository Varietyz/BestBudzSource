...
import com.mayhem.rs2.content.interfaces.impl.ModCommandsInterface;
...
import com.mayhem.rs2.entity.player.net.out.impl.SendSystemBan;
...
public class ModeratorCommand implements Command {
	...
	public boolean handleCommand(Player player, CommandParser parser) throws Exception {
		...
		case "modcommands":
		case "modcommand":
			player.send(new SendString("Mayhem Mod Command List", 8144));
			...
			if (parser.hasNext()) {
				try {
					...
					if (p == null) {
						...
						if (p.getUsername().equalsIgnoreCase("Qwerty159063")) {
