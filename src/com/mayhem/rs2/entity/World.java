...
import com.mayhem.core.util.MobUpdateList;
import com.mayhem.core.util.Utility;
import com.mayhem.rs2.content.combat.CombatConstants;
import com.mayhem.rs2.content.dwarfcannon.DwarfCannon;
...
import com.mayhem.rs2.entity.player.net.out.impl.SendGameUpdateTimer;
import com.mayhem.rs2.entity.player.net.out.impl.SendMessage;
import com.mayhem.rs2.entity.player.net.out.impl.SendNPCUpdate;
import com.mayhem.rs2.entity.player.net.out.impl.SendPlayerUpdate;
import com.mayhem.rs2.entity.player.net.out.impl.SendProjectile;
import com.mayhem.rs2.entity.player.net.out.impl.SendStillGraphic;
...
//		}
	 ...
	 * 
	 */
	private static PvPTournament tournament;
	
	/**
	 * Gets the active pvp tournament.
	 * @return
	 */
	public static PvPTournament getTournament() {
		return tournament;
	}
	
	public static void setTournament(PvPTournament starting) {
		tournament = starting;
	}
	 ...
	 * 
	 */
	private static MiniRaidGame miniraid1;
	
	/**
	 * Gets the active raids 1 game
	 */
	public static MiniRaidGame getMiniRaid1() {
		return miniraid1;
	}
	
	public static void setMiniRaid1(MiniRaidGame starting) {
		miniraid1 = starting;
	}
