...
public abstract class Entity implements CombatInterface {
	...
	public boolean inMultiArea() {
		...
		if (attributes.get(MiniRaidGame.MINIRAID_GAME_KEY) != null) {
			return true;
		}
		
		if (attributes.get(MiniRaid2Game.MINIRAID2_GAME_KEY) != null) {
			return true;
		}
	...
	public boolean inWilderness() {
		int x = location.getX();
		int y = location.getY();
		return (x > 2941 && x < 3392 && y > 3521 && y < 3967) || (x > 2941 && x < 3392 && y > 9918 && y < 10366) || (x > 2583 && x < 2729 && y > 3255 && y < 3343) || (x > 1580 && x < 1658 && y > 3565 && y < 3656);
	}
