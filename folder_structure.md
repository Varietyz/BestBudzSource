...
├─ 📂 build
│   ├─ 📂 distributions
│   │   ├─ 📄 BestBudzServer-1.0-SNAPSHOT.tar
│   │   └─ 📄 BestBudzServer-1.0-SNAPSHOT.zip
│   ├─ 📂 generated
│   │   └─ 📂 sources
│   │       ├─ 📂 annotationProcessor
│   │       │   └─ 📂 java
...
│   │               └─ 📂 main
│   ├─ 📂 libs
│   │   └─ 📄 BestBudzServer-1.0-SNAPSHOT.jar
│   ├─ 📂 resources
│   │   └─ 📂 main
│   │       ├─ 📂 characters
│   │       │   ├─ 📂 containers
...
│           │   │   │   │   ├─ 📄 PilesDialogue.java
│           │   │   │   │   ├─ 📄 SailorDialogue.java
│           │   │   │   │   ├─ 📄 ShopExchangeDialogue.java
│           │   │   │   │   ├─ 📄 ShopExchangeDialogue2.java
...
│           │   │   │   │   ├─ 📄 Hops.java
│           │   │   │   │   ├─ 📄 Seedling.java
│           │   │   │   │   ├─ 📄 SpecialPlantOne.java
│           │   │   │   │   ├─ 📄 SpecialPlantTwo.java
│           │   │   │   │   ├─ 📄 Weeds.java
│           │   │   │   │   └─ 📄 WoodTrees.java
│           │   │   │   ├─ 📂 fisher
│           │   │   │   │   ├─ 📄 FishableData.java
...
│           ├─ 📄 Server.java
│           └─ 📂 tools
│               ├─ 📄 IkushzDropParser.java
│               ├─ 📄 JayBaneDropParser.java
│               ├─ 📄 JsonSaver.java
│               └─ 📄 LastModifiedFiles.java
└─ 📝 TODO.MD
```